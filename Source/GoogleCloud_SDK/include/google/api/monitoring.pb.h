...
class Monitoring_MonitoringDestination final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR Monitoring_MonitoringDestination(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const Monitoring_MonitoringDestination& from) {
    Monitoring_MonitoringDestination::MergeImpl(*this, from);
  }
  private:
...
class Monitoring final :
 ...
 public:
  ...
  ~Monitoring() override;
  explicit PROTOBUF_CONSTEXPR Monitoring(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const Monitoring& from) {
    Monitoring::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
