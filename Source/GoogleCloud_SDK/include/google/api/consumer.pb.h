...
enum Property_PropertyType : int {
  ...
  Property_PropertyType_Property_PropertyType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Property_PropertyType_Property_PropertyType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class ProjectProperties final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ProjectProperties(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ProjectProperties* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const ProjectProperties& from) {
    ProjectProperties::MergeImpl(*this, from);
  }
  private:
