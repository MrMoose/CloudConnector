...
class Logging_LoggingDestination final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR Logging_LoggingDestination(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const Logging_LoggingDestination& from) {
    Logging_LoggingDestination::MergeImpl(*this, from);
  }
  private:
...
class Logging final :
 ...
 public:
  ...
  ~Logging() override;
  explicit PROTOBUF_CONSTEXPR Logging(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline int Logging::_internal_producer_destinations_size() const {
  return _impl_.producer_destinations_.size();
}
...
inline ::google::api::Logging_LoggingDestination* Logging::mutable_producer_destinations(int index) {
  ...
  return _impl_.producer_destinations_.Mutable(index);
}
...
inline const ::google::api::Logging_LoggingDestination& Logging::_internal_producer_destinations(int index) const {
  return _impl_.producer_destinations_.Get(index);
}
...
inline ::google::api::Logging_LoggingDestination* Logging::_internal_add_producer_destinations() {
  return _impl_.producer_destinations_.Add();
}
