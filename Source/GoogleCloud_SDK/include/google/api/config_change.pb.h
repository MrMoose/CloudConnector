...
class Advice final :
 ...
 public:
  ...
  ~Advice() override;
  explicit PROTOBUF_CONSTEXPR Advice(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void ConfigChange::set_element(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.element_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ConfigChange::_internal_set_element(const std::string& value) {
  ...
  _impl_.element_.Set(value, GetArenaForAllocation());
}
inline std::string* ConfigChange::_internal_mutable_element() {
  
  return _impl_.element_.Mutable(GetArenaForAllocation());
}
...
inline void ConfigChange::set_allocated_element(std::string* element) {
  ...
  _impl_.element_.SetAllocated(element, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.element_.IsDefault()) {
...
inline ::google::api::Advice* ConfigChange::mutable_advices(int index) {
  ...
  return _impl_.advices_.Mutable(index);
}
...
inline const ::google::api::Advice& ConfigChange::_internal_advices(int index) const {
  return _impl_.advices_.Get(index);
}
