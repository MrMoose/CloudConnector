...
class RoutingRule final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RoutingRule(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RoutingParameter final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR RoutingParameter(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void MergeFrom( const RoutingParameter& from) {
    RoutingParameter::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
...
inline int RoutingRule::_internal_routing_parameters_size() const {
  return _impl_.routing_parameters_.size();
}
...
inline ::google::api::RoutingParameter* RoutingRule::mutable_routing_parameters(int index) {
  ...
  return _impl_.routing_parameters_.Mutable(index);
}
...
inline const ::google::api::RoutingParameter& RoutingRule::_internal_routing_parameters(int index) const {
  return _impl_.routing_parameters_.Get(index);
}
...
inline ::google::api::RoutingParameter* RoutingRule::_internal_add_routing_parameters() {
  return _impl_.routing_parameters_.Add();
}
...
void RoutingParameter::set_path_template(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.path_template_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RoutingParameter::_internal_set_path_template(const std::string& value) {
  ...
  _impl_.path_template_.Set(value, GetArenaForAllocation());
}
inline std::string* RoutingParameter::_internal_mutable_path_template() {
  
  return _impl_.path_template_.Mutable(GetArenaForAllocation());
}
...
inline void RoutingParameter::set_allocated_path_template(std::string* path_template) {
  ...
  _impl_.path_template_.SetAllocated(path_template, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.path_template_.IsDefault()) {
