...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fapi_2fmetric_2eproto_metadata_getter(int index);
namespace google {
namespace api {
class Metric;
...
class MetricDescriptor_MetricDescriptorMetadata PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fapi_2fmetric_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline ::google::api::MetricDescriptor_MetricDescriptorMetadata* MetricDescriptor::_internal_mutable_metadata() {
  ...
  if (metadata_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::api::MetricDescriptor_MetricDescriptorMetadata>(GetArena());
    metadata_ = p;
  }
  return metadata_;
}
...
inline std::string* MetricDescriptor::add_monitored_resource_types() {
  ...
  return _internal_add_monitored_resource_types();
}
