...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fapi_2fhttpbody_2eproto_metadata_getter(int index);
namespace google {
namespace api {
class HttpBody;
...
class HttpBody PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fapi_2fhttpbody_2eproto_metadata_getter(kIndexInFileMessages);
  }
