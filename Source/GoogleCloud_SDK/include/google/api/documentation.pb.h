...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fapi_2fdocumentation_2eproto_metadata_getter(int index);
namespace google {
namespace api {
class Documentation;
...
class Documentation PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fapi_2fdocumentation_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  void set_service_root_url(std::string&& value);
  ...
  void _internal_set_service_root_url(const std::string& value);
...
inline void Documentation::set_service_root_url(const std::string& value) {
  _internal_set_service_root_url(value);
...
inline std::string* Documentation::mutable_service_root_url() {
  ...
  return _internal_mutable_service_root_url();
}
...
inline void Documentation::_internal_set_service_root_url(const std::string& value) {
  ...
  service_root_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Documentation::set_service_root_url(std::string&& value) {
  
  service_root_url_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.api.Documentation.service_root_url)
}
inline void Documentation::set_service_root_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  service_root_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.api.Documentation.service_root_url)
}
inline void Documentation::set_service_root_url(const char* value,
    size_t size) {
  
  service_root_url_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* Documentation::_internal_mutable_service_root_url() {
  ...
  return service_root_url_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Documentation::release_service_root_url() {
  ...
  return service_root_url_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
