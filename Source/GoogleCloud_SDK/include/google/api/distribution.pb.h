...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fapi_2fdistribution_2eproto_metadata_getter(int index);
namespace google {
namespace api {
class Distribution;
...
class Distribution_Range PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fapi_2fdistribution_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Distribution_BucketOptions_Linear PROTOBUF_FINAL :
...
class Distribution_BucketOptions_Exponential PROTOBUF_FINAL :
...
class Distribution_BucketOptions_Explicit PROTOBUF_FINAL :
...
class Distribution_BucketOptions PROTOBUF_FINAL :
...
class Distribution_Exemplar PROTOBUF_FINAL :
...
inline ::google::api::Distribution_BucketOptions_Linear* Distribution_BucketOptions::_internal_mutable_linear_buckets() {
  if (!_internal_has_linear_buckets()) {
    clear_options();
    set_has_linear_buckets();
    options_.linear_buckets_ = CreateMaybeMessage< ::google::api::Distribution_BucketOptions_Linear >(GetArena());
  }
...
inline ::google::api::Distribution_BucketOptions_Exponential* Distribution_BucketOptions::_internal_mutable_exponential_buckets() {
  if (!_internal_has_exponential_buckets()) {
    clear_options();
    set_has_exponential_buckets();
    options_.exponential_buckets_ = CreateMaybeMessage< ::google::api::Distribution_BucketOptions_Exponential >(GetArena());
  }
...
inline ::google::api::Distribution_BucketOptions_Explicit* Distribution_BucketOptions::_internal_mutable_explicit_buckets() {
  if (!_internal_has_explicit_buckets()) {
    clear_options();
    set_has_explicit_buckets();
    options_.explicit_buckets_ = CreateMaybeMessage< ::google::api::Distribution_BucketOptions_Explicit >(GetArena());
  }
...
inline ::google::api::Distribution_Range* Distribution::_internal_mutable_range() {
  ...
  if (range_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::api::Distribution_Range>(GetArena());
    range_ = p;
  }
  return range_;
}
...
inline void Distribution::set_allocated_bucket_options(::google::api::Distribution_BucketOptions* bucket_options) {
  ...
  if (bucket_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(bucket_options);
    if (message_arena != submessage_arena) {
