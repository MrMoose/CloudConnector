...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2ftype_2fphone_5fnumber_2eproto_metadata_getter(int index);
namespace google {
namespace type {
class PhoneNumber;
...
class PhoneNumber_ShortCode PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2ftype_2fphone_5fnumber_2eproto_metadata_getter(kIndexInFileMessages);
  }
