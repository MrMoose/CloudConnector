...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2ftype_2ffraction_2eproto_metadata_getter(int index);
namespace google {
namespace type {
class Fraction;
...
class Fraction PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~Fraction();
  explicit constexpr Fraction(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2ftype_2ffraction_2eproto_metadata_getter(kIndexInFileMessages);
  }
