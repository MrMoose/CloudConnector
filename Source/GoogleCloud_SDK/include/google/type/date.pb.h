...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2ftype_2fdate_2eproto_metadata_getter(int index);
namespace google {
namespace type {
class Date;
...
class Date PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2ftype_2fdate_2eproto_metadata_getter(kIndexInFileMessages);
  }
