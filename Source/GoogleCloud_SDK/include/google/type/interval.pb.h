...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2ftype_2finterval_2eproto_metadata_getter(int index);
namespace google {
namespace type {
class Interval;
...
class Interval PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2ftype_2finterval_2eproto_metadata_getter(kIndexInFileMessages);
  }
