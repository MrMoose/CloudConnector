...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2flogging_2fv2_2flog_5fentry_2eproto_metadata_getter(int index);
namespace google {
namespace logging {
namespace v2 {
class LogEntry;
...
class LogEntry PROTOBUF_FINAL :
 ...
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2flogging_2fv2_2flog_5fentry_2eproto_metadata_getter(kIndexInFileMessages);
  }
