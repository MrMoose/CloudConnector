...
#ifndef GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto
...
struct TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
...
template<> ::google::cloud::dialogflow::v2beta1::QueryParameters_WebhookHeadersEntry_DoNotUse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::QueryParameters_WebhookHeadersEntry_DoNotUse>(Arena*);
...
enum KnowledgeAnswers_Answer_MatchConfidenceLevel : int {
  ...
  KnowledgeAnswers_Answer_MatchConfidenceLevel_KnowledgeAnswers_Answer_MatchConfidenceLevel_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  KnowledgeAnswers_Answer_MatchConfidenceLevel_KnowledgeAnswers_Answer_MatchConfidenceLevel_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool KnowledgeAnswers_Answer_MatchConfidenceLevel_IsValid(int value);
constexpr KnowledgeAnswers_Answer_MatchConfidenceLevel KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_MIN = KnowledgeAnswers_Answer_MatchConfidenceLevel_MATCH_CONFIDENCE_LEVEL_UNSPECIFIED;
constexpr KnowledgeAnswers_Answer_MatchConfidenceLevel KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_MAX = KnowledgeAnswers_Answer_MatchConfidenceLevel_HIGH;
constexpr int KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_ARRAYSIZE = KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* KnowledgeAnswers_Answer_MatchConfidenceLevel_descriptor();
template<typename T>
inline const std::string& KnowledgeAnswers_Answer_MatchConfidenceLevel_Name(T enum_t_value) {
  static_assert(::std::is_same<T, KnowledgeAnswers_Answer_MatchConfidenceLevel>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function KnowledgeAnswers_Answer_MatchConfidenceLevel_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    KnowledgeAnswers_Answer_MatchConfidenceLevel_descriptor(), enum_t_value);
}
inline bool KnowledgeAnswers_Answer_MatchConfidenceLevel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, KnowledgeAnswers_Answer_MatchConfidenceLevel* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<KnowledgeAnswers_Answer_MatchConfidenceLevel>(
...
enum StreamingRecognitionResult_MessageType : int {
  ...
  StreamingRecognitionResult_MessageType_DTMF_DIGITS = 3,
  StreamingRecognitionResult_MessageType_END_OF_SINGLE_UTTERANCE = 2,
  StreamingRecognitionResult_MessageType_PARTIAL_DTMF_DIGITS = 4,
...
constexpr StreamingRecognitionResult_MessageType StreamingRecognitionResult_MessageType_MessageType_MAX = StreamingRecognitionResult_MessageType_PARTIAL_DTMF_DIGITS;
...
class DetectIntentRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.DetectIntentRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.DetectIntentRequest";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  ::google::cloud::dialogflow::v2beta1::QueryParameters* _internal_mutable_query_params();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::QueryInput* _internal_mutable_query_input();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::OutputAudioConfig* _internal_mutable_output_audio_config();
  public:
 ...
 private:
  ...
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto;
};
// -------------------------------------------------------------------

class DetectIntentResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.DetectIntentResponse) */ {
 public:
  ...
  enum : int {
    kAlternativeQueryResultsFieldNumber = 5,
  ...
  private:
  int _internal_alternative_query_results_size() const;
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::QueryResult >*
      mutable_alternative_query_results();
  private:
  const ::google::cloud::dialogflow::v2beta1::QueryResult& _internal_alternative_query_results(int index) const;
  ::google::cloud::dialogflow::v2beta1::QueryResult* _internal_add_alternative_query_results();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::QueryResult >&
  ...
  ::google::cloud::dialogflow::v2beta1::QueryResult* _internal_mutable_query_result();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::QueryResult > alternative_query_results_;
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2beta1.QueryParameters.WebhookHeadersEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2beta1.QueryParameters.WebhookHeadersEntry.value");
 }
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& other) final;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto);
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto.file_level_metadata[2];
  }
...
class QueryParameters PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.QueryParameters) */ {
 public:
  ...
  enum : int {
    ...
    kKnowledgeBaseNamesFieldNumber = 12,
    kSubAgentsFieldNumber = 13,
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context >*
      mutable_contexts();
  private:
  const ::google::cloud::dialogflow::v2beta1::Context& _internal_contexts(int index) const;
  ::google::cloud::dialogflow::v2beta1::Context* _internal_add_contexts();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context >&
      contexts() const;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SessionEntityType >*
      mutable_session_entity_types();
  private:
  const ::google::cloud::dialogflow::v2beta1::SessionEntityType& _internal_session_entity_types(int index) const;
  ::google::cloud::dialogflow::v2beta1::SessionEntityType* _internal_add_session_entity_types();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SessionEntityType >&
      session_entity_types() const;

  // repeated string knowledge_base_names = 12;
  int knowledge_base_names_size() const;
  private:
  int _internal_knowledge_base_names_size() const;
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& knowledge_base_names() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_knowledge_base_names();
  private:
  const std::string& _internal_knowledge_base_names(int index) const;
  std::string* _internal_add_knowledge_base_names();
  public:

  // repeated .google.cloud.dialogflow.v2beta1.SubAgent sub_agents = 13;
  int sub_agents_size() const;
  private:
  int _internal_sub_agents_size() const;
  public:
  void clear_sub_agents();
  ::google::cloud::dialogflow::v2beta1::SubAgent* mutable_sub_agents(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SubAgent >*
      mutable_sub_agents();
  private:
  const ::google::cloud::dialogflow::v2beta1::SubAgent& _internal_sub_agents(int index) const;
  ::google::cloud::dialogflow::v2beta1::SubAgent* _internal_add_sub_agents();
  public:
  const ::google::cloud::dialogflow::v2beta1::SubAgent& sub_agents(int index) const;
  ::google::cloud::dialogflow::v2beta1::SubAgent* add_sub_agents();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SubAgent >&
      sub_agents() const;
  ...
  ::google::cloud::dialogflow::v2beta1::SentimentAnalysisRequestConfig* _internal_mutable_sentiment_analysis_request_config();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context > contexts_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SessionEntityType > session_entity_types_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> knowledge_base_names_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SubAgent > sub_agents_;
...
class QueryInput PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.QueryInput) */ {
 public:
  ...
  ::google::cloud::dialogflow::v2beta1::InputAudioConfig* _internal_mutable_audio_config();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::TextInput* _internal_mutable_text();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::EventInput* _internal_mutable_event();
  public:
  ...
  bool has_dtmf() const;
  private:
  bool _internal_has_dtmf() const;
  public:
  void clear_dtmf();
  const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& dtmf() const;
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* release_dtmf();
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* mutable_dtmf();
  void set_allocated_dtmf(::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf);
  private:
  const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& _internal_dtmf() const;
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* _internal_mutable_dtmf();
  public:
  void unsafe_arena_set_allocated_dtmf(
      ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf);
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* unsafe_arena_release_dtmf();
 ...
 private:
  ...
  union InputUnion {
    ...
    ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf_;
  } input_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class QueryResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.QueryResult) */ {
 public:
  ...
  enum : int {
    ...
    kKnowledgeAnswersFieldNumber = 18,
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Intent_Message >*
      mutable_fulfillment_messages();
  private:
  const ::google::cloud::dialogflow::v2beta1::Intent_Message& _internal_fulfillment_messages(int index) const;
  ::google::cloud::dialogflow::v2beta1::Intent_Message* _internal_add_fulfillment_messages();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Intent_Message >&
  ...
  private:
  const ::google::cloud::dialogflow::v2beta1::Context& _internal_output_contexts(int index) const;
  ::google::cloud::dialogflow::v2beta1::Context* _internal_add_output_contexts();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::Intent* _internal_mutable_intent();
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::SentimentAnalysisResult* _internal_mutable_sentiment_analysis_result();
  public:
  ...
  private:
  bool _internal_has_knowledge_answers() const;
  public:
  ...
  ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers* _internal_mutable_knowledge_answers();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Intent_Message > fulfillment_messages_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context > output_contexts_;
...
class KnowledgeAnswers_Answer PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer) */ {
 public:
  inline KnowledgeAnswers_Answer() : KnowledgeAnswers_Answer(nullptr) {}
  virtual ~KnowledgeAnswers_Answer();
  explicit constexpr KnowledgeAnswers_Answer(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(KnowledgeAnswers_Answer* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  inline KnowledgeAnswers_Answer* New() const final {
    return CreateMaybeMessage<KnowledgeAnswers_Answer>(nullptr);
  }

  KnowledgeAnswers_Answer* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer";
  }
  protected:
  explicit KnowledgeAnswers_Answer(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  static constexpr MatchConfidenceLevel MATCH_CONFIDENCE_LEVEL_UNSPECIFIED =
    KnowledgeAnswers_Answer_MatchConfidenceLevel_MATCH_CONFIDENCE_LEVEL_UNSPECIFIED;
  static constexpr MatchConfidenceLevel LOW =
    KnowledgeAnswers_Answer_MatchConfidenceLevel_LOW;
  static constexpr MatchConfidenceLevel MEDIUM =
    KnowledgeAnswers_Answer_MatchConfidenceLevel_MEDIUM;
  static constexpr MatchConfidenceLevel HIGH =
  ...
  static constexpr MatchConfidenceLevel MatchConfidenceLevel_MIN =
    KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_MIN;
  static constexpr MatchConfidenceLevel MatchConfidenceLevel_MAX =
    KnowledgeAnswers_Answer_MatchConfidenceLevel_MatchConfidenceLevel_MAX;
  static constexpr int MatchConfidenceLevel_ARRAYSIZE =
  ...
  template<typename T>
  static inline const std::string& MatchConfidenceLevel_Name(T enum_t_value) {
    static_assert(::std::is_same<T, MatchConfidenceLevel>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function MatchConfidenceLevel_Name.");
    return KnowledgeAnswers_Answer_MatchConfidenceLevel_Name(enum_t_value);
  }
  static inline bool MatchConfidenceLevel_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  enum : int {
    ...
    kFaqQuestionFieldNumber = 2,
    kAnswerFieldNumber = 3,
    kMatchConfidenceLevelFieldNumber = 4,
    kMatchConfidenceFieldNumber = 5,
  };
  ...
  private:
  const std::string& _internal_faq_question() const;
  void _internal_set_faq_question(const std::string& value);
  std::string* _internal_mutable_faq_question();
  public:
  ...
  private:
  ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel _internal_match_confidence_level() const;
  void _internal_set_match_confidence_level(::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel value);
  public:
  ...
  private:
  float _internal_match_confidence() const;
  void _internal_set_match_confidence(float value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr faq_question_;
...
class KnowledgeAnswers PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.KnowledgeAnswers) */ {
 public:
  inline KnowledgeAnswers() : KnowledgeAnswers(nullptr) {}
  virtual ~KnowledgeAnswers();
  explicit constexpr KnowledgeAnswers(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void Swap(KnowledgeAnswers* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  inline KnowledgeAnswers* New() const final {
    return CreateMaybeMessage<KnowledgeAnswers>(nullptr);
  }

  KnowledgeAnswers* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  protected:
  explicit KnowledgeAnswers(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer >*
      mutable_answers();
  private:
  const ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer& _internal_answers(int index) const;
  ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer* _internal_add_answers();
  public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer >&
      answers() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer > answers_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto;
};
// -------------------------------------------------------------------
...
class StreamingDetectIntentRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest";
  }
  protected:
...
class StreamingDetectIntentResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.StreamingDetectIntentResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.StreamingDetectIntentResponse";
  }
  protected:
  ...
  enum : int {
    kAlternativeQueryResultsFieldNumber = 7,
    kResponseIdFieldNumber = 1,
  ...
  ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult* _internal_mutable_recognition_result();
  public:
...
class StreamingRecognitionResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult) */ {
 public:
  ...
  static constexpr MessageType DTMF_DIGITS =
    StreamingRecognitionResult_MessageType_DTMF_DIGITS;
  static constexpr MessageType END_OF_SINGLE_UTTERANCE =
    StreamingRecognitionResult_MessageType_END_OF_SINGLE_UTTERANCE;
  static constexpr MessageType PARTIAL_DTMF_DIGITS =
    StreamingRecognitionResult_MessageType_PARTIAL_DTMF_DIGITS;
  ...
  ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* mutable_speech_word_info(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SpeechWordInfo >*
      mutable_speech_word_info();
  private:
  const ::google::cloud::dialogflow::v2beta1::SpeechWordInfo& _internal_speech_word_info(int index) const;
  ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* _internal_add_speech_word_info();
  public:
  const ::google::cloud::dialogflow::v2beta1::SpeechWordInfo& speech_word_info(int index) const;
  ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* add_speech_word_info();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SpeechWordInfo >&
  ...
  const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& dtmf_digits() const;
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* release_dtmf_digits();
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* mutable_dtmf_digits();
  void set_allocated_dtmf_digits(::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf_digits);
  private:
  const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& _internal_dtmf_digits() const;
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* _internal_mutable_dtmf_digits();
  public:
  void unsafe_arena_set_allocated_dtmf_digits(
      ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf_digits);
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* unsafe_arena_release_dtmf_digits();
  ...
  private:
  ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult_MessageType _internal_message_type() const;
  void _internal_set_message_type(::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult_MessageType value);
  public:
...
class TextInput PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.TextInput) */ {
 public:
...
class EventInput PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.EventInput) */ {
 public:
...
class SentimentAnalysisRequestConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.SentimentAnalysisRequestConfig) */ {
 public:
...
class SentimentAnalysisResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.SentimentAnalysisResult) */ {
 public:
  ...
  ::google::cloud::dialogflow::v2beta1::Sentiment* _internal_mutable_query_text_sentiment();
  public:
...
class Sentiment PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.Sentiment) */ {
 public:
...
inline const ::google::cloud::dialogflow::v2beta1::QueryParameters& DetectIntentRequest::_internal_query_params() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::QueryParameters&>(
...
inline ::google::cloud::dialogflow::v2beta1::QueryParameters* DetectIntentRequest::_internal_mutable_query_params() {
  
  if (query_params_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::QueryParameters>(GetArena());
    query_params_ = p;
  }
...
inline const ::google::cloud::dialogflow::v2beta1::QueryInput& DetectIntentRequest::_internal_query_input() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::QueryInput&>(
...
inline ::google::cloud::dialogflow::v2beta1::QueryInput* DetectIntentRequest::_internal_mutable_query_input() {
  
  if (query_input_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::QueryInput>(GetArena());
    query_input_ = p;
  }
  return query_input_;
}
...
inline const ::google::cloud::dialogflow::v2beta1::OutputAudioConfig& DetectIntentRequest::_internal_output_audio_config() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::OutputAudioConfig&>(
...
inline ::google::cloud::dialogflow::v2beta1::OutputAudioConfig* DetectIntentRequest::_internal_mutable_output_audio_config() {
  
  if (output_audio_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::OutputAudioConfig>(GetArena());
...
inline const PROTOBUF_NAMESPACE_ID::FieldMask& DetectIntentRequest::output_audio_config_mask() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.DetectIntentRequest.output_audio_config_mask)
...
inline void DetectIntentRequest::unsafe_arena_set_allocated_output_audio_config_mask(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.DetectIntentRequest.output_audio_config_mask)
}
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* DetectIntentRequest::unsafe_arena_release_output_audio_config_mask() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.DetectIntentRequest.output_audio_config_mask)
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* DetectIntentRequest::mutable_output_audio_config_mask() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.DetectIntentRequest.output_audio_config_mask)
...
inline void DetectIntentRequest::set_allocated_output_audio_config_mask(PROTOBUF_NAMESPACE_ID::FieldMask* output_audio_config_mask) {
  ...
  output_audio_config_mask_ = output_audio_config_mask;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.DetectIntentRequest.output_audio_config_mask)
}
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& DetectIntentResponse::_internal_query_result() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::QueryResult&>(
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* DetectIntentResponse::_internal_mutable_query_result() {
  
  if (query_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::QueryResult>(GetArena());
    query_result_ = p;
  }
...
// repeated .google.cloud.dialogflow.v2beta1.QueryResult alternative_query_results = 5;
inline int DetectIntentResponse::_internal_alternative_query_results_size() const {
  return alternative_query_results_.size();
}
inline int DetectIntentResponse::alternative_query_results_size() const {
  return _internal_alternative_query_results_size();
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::QueryResult >*
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& DetectIntentResponse::_internal_alternative_query_results(int index) const {
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& DetectIntentResponse::alternative_query_results(int index) const {
  ...
  return _internal_alternative_query_results(index);
}
inline ::google::cloud::dialogflow::v2beta1::QueryResult* DetectIntentResponse::_internal_add_alternative_query_results() {
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* DetectIntentResponse::add_alternative_query_results() {
  ...
  return _internal_add_alternative_query_results();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::QueryResult >&
...
inline ::google::cloud::dialogflow::v2beta1::OutputAudioConfig* DetectIntentResponse::_internal_mutable_output_audio_config() {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context >*
...
inline const ::google::cloud::dialogflow::v2beta1::Context& QueryParameters::_internal_contexts(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::Context* QueryParameters::_internal_add_contexts() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Context >&
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SessionEntityType >*
...
inline const ::google::cloud::dialogflow::v2beta1::SessionEntityType& QueryParameters::_internal_session_entity_types(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::SessionEntityType* QueryParameters::_internal_add_session_entity_types() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SessionEntityType >&
...
// repeated string knowledge_base_names = 12;
inline int QueryParameters::_internal_knowledge_base_names_size() const {
  return knowledge_base_names_.size();
}
inline int QueryParameters::knowledge_base_names_size() const {
  return _internal_knowledge_base_names_size();
}
...
inline std::string* QueryParameters::add_knowledge_base_names() {
  ...
  return _internal_add_knowledge_base_names();
}
inline const std::string& QueryParameters::_internal_knowledge_base_names(int index) const {
...
inline const std::string& QueryParameters::knowledge_base_names(int index) const {
  ...
  return _internal_knowledge_base_names(index);
}
...
inline std::string* QueryParameters::_internal_add_knowledge_base_names() {
...
inline const ::google::cloud::dialogflow::v2beta1::SentimentAnalysisRequestConfig& QueryParameters::_internal_sentiment_analysis_request_config() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::SentimentAnalysisRequestConfig&>(
...
inline ::google::cloud::dialogflow::v2beta1::SentimentAnalysisRequestConfig* QueryParameters::_internal_mutable_sentiment_analysis_request_config() {
  
  if (sentiment_analysis_request_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::SentimentAnalysisRequestConfig>(GetArena());
...
// repeated .google.cloud.dialogflow.v2beta1.SubAgent sub_agents = 13;
inline int QueryParameters::_internal_sub_agents_size() const {
  return sub_agents_.size();
}
inline int QueryParameters::sub_agents_size() const {
  return _internal_sub_agents_size();
}
inline ::google::cloud::dialogflow::v2beta1::SubAgent* QueryParameters::mutable_sub_agents(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.QueryParameters.sub_agents)
  return sub_agents_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SubAgent >*
QueryParameters::mutable_sub_agents() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.QueryParameters.sub_agents)
  return &sub_agents_;
}
inline const ::google::cloud::dialogflow::v2beta1::SubAgent& QueryParameters::_internal_sub_agents(int index) const {
  return sub_agents_.Get(index);
}
inline const ::google::cloud::dialogflow::v2beta1::SubAgent& QueryParameters::sub_agents(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.QueryParameters.sub_agents)
  return _internal_sub_agents(index);
}
inline ::google::cloud::dialogflow::v2beta1::SubAgent* QueryParameters::_internal_add_sub_agents() {
  return sub_agents_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::SubAgent* QueryParameters::add_sub_agents() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.QueryParameters.sub_agents)
  return _internal_add_sub_agents();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SubAgent >&
QueryParameters::sub_agents() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.QueryParameters.sub_agents)
  return sub_agents_;
}
...
QueryParameters::webhook_headers() const {
  // @@protoc_insertion_point(field_map:google.cloud.dialogflow.v2beta1.QueryParameters.webhook_headers)
...
QueryParameters::mutable_webhook_headers() {
  // @@protoc_insertion_point(field_mutable_map:google.cloud.dialogflow.v2beta1.QueryParameters.webhook_headers)
...
inline ::google::cloud::dialogflow::v2beta1::InputAudioConfig* QueryInput::_internal_mutable_audio_config() {
  if (!_internal_has_audio_config()) {
    clear_input();
    set_has_audio_config();
    input_.audio_config_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2beta1::InputAudioConfig >(GetArena());
  }
...
inline ::google::cloud::dialogflow::v2beta1::TextInput* QueryInput::_internal_mutable_text() {
  if (!_internal_has_text()) {
    clear_input();
    set_has_text();
    input_.text_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2beta1::TextInput >(GetArena());
  }
  return input_.text_;
}
...
inline ::google::cloud::dialogflow::v2beta1::EventInput* QueryInput::_internal_mutable_event() {
  if (!_internal_has_event()) {
    clear_input();
    set_has_event();
    input_.event_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2beta1::EventInput >(GetArena());
  }
...
// .google.cloud.dialogflow.v2beta1.TelephonyDtmfEvents dtmf = 4;
inline bool QueryInput::_internal_has_dtmf() const {
  return input_case() == kDtmf;
}
inline bool QueryInput::has_dtmf() const {
  return _internal_has_dtmf();
}
inline void QueryInput::set_has_dtmf() {
  _oneof_case_[0] = kDtmf;
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* QueryInput::release_dtmf() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.QueryInput.dtmf)
  if (_internal_has_dtmf()) {
    clear_has_input();
      ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* temp = input_.dtmf_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    input_.dtmf_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& QueryInput::_internal_dtmf() const {
  return _internal_has_dtmf()
      ? *input_.dtmf_
      : reinterpret_cast< ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents&>(::google::cloud::dialogflow::v2beta1::_TelephonyDtmfEvents_default_instance_);
}
inline const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& QueryInput::dtmf() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.QueryInput.dtmf)
  return _internal_dtmf();
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* QueryInput::unsafe_arena_release_dtmf() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2beta1.QueryInput.dtmf)
  if (_internal_has_dtmf()) {
    clear_has_input();
    ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* temp = input_.dtmf_;
    input_.dtmf_ = nullptr;
...
inline void QueryInput::unsafe_arena_set_allocated_dtmf(::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf) {
  clear_input();
  if (dtmf) {
    set_has_dtmf();
    input_.dtmf_ = dtmf;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.QueryInput.dtmf)
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* QueryInput::_internal_mutable_dtmf() {
  if (!_internal_has_dtmf()) {
    clear_input();
    set_has_dtmf();
    input_.dtmf_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents >(GetArena());
  }
  return input_.dtmf_;
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* QueryInput::mutable_dtmf() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.QueryInput.dtmf)
  return _internal_mutable_dtmf();
}
...
inline bool QueryResult::cancels_slot_filling() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.QueryResult.cancels_slot_filling)
...
inline void QueryResult::set_cancels_slot_filling(bool value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.QueryResult.cancels_slot_filling)
}
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Intent_Message >*
...
inline const ::google::cloud::dialogflow::v2beta1::Intent_Message& QueryResult::_internal_fulfillment_messages(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::Intent_Message* QueryResult::_internal_add_fulfillment_messages() {
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Intent_Message >&
...
inline const ::google::cloud::dialogflow::v2beta1::Context& QueryResult::_internal_output_contexts(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::Context* QueryResult::_internal_add_output_contexts() {
...
inline const ::google::cloud::dialogflow::v2beta1::Intent& QueryResult::_internal_intent() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::Intent&>(
...
inline ::google::cloud::dialogflow::v2beta1::Intent* QueryResult::_internal_mutable_intent() {
  
  if (intent_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Intent>(GetArena());
    intent_ = p;
  }
  return intent_;
}
...
inline const ::google::cloud::dialogflow::v2beta1::SentimentAnalysisResult& QueryResult::_internal_sentiment_analysis_result() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::SentimentAnalysisResult&>(
...
inline ::google::cloud::dialogflow::v2beta1::SentimentAnalysisResult* QueryResult::_internal_mutable_sentiment_analysis_result() {
  
  if (sentiment_analysis_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::SentimentAnalysisResult>(GetArena());
...
// .google.cloud.dialogflow.v2beta1.KnowledgeAnswers knowledge_answers = 18;
inline bool QueryResult::_internal_has_knowledge_answers() const {
  return this != internal_default_instance() && knowledge_answers_ != nullptr;
}
inline bool QueryResult::has_knowledge_answers() const {
  return _internal_has_knowledge_answers();
}
inline void QueryResult::clear_knowledge_answers() {
  if (GetArena() == nullptr && knowledge_answers_ != nullptr) {
    delete knowledge_answers_;
  }
  knowledge_answers_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers& QueryResult::_internal_knowledge_answers() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers&>(
...
inline const ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers& QueryResult::knowledge_answers() const {
  ...
  return _internal_knowledge_answers();
}
inline void QueryResult::unsafe_arena_set_allocated_knowledge_answers(
    ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers* knowledge_answers) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(knowledge_answers_);
  }
...
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers* QueryResult::_internal_mutable_knowledge_answers() {
  
  if (knowledge_answers_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::KnowledgeAnswers>(GetArena());
...
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers* QueryResult::mutable_knowledge_answers() {
  ...
  return _internal_mutable_knowledge_answers();
}
inline void QueryResult::set_allocated_knowledge_answers(::google::cloud::dialogflow::v2beta1::KnowledgeAnswers* knowledge_answers) {
  ...
  if (knowledge_answers) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(knowledge_answers);
    if (message_arena != submessage_arena) {
      knowledge_answers = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline const std::string& KnowledgeAnswers_Answer::_internal_source() const {
  return source_.Get();
}
inline void KnowledgeAnswers_Answer::_internal_set_source(const std::string& value) {
...
inline std::string* KnowledgeAnswers_Answer::_internal_mutable_source() {
...
inline std::string* KnowledgeAnswers_Answer::mutable_faq_question() {
  ...
  return _internal_mutable_faq_question();
}
inline const std::string& KnowledgeAnswers_Answer::_internal_faq_question() const {
  return faq_question_.Get();
}
inline void KnowledgeAnswers_Answer::_internal_set_faq_question(const std::string& value) {
  
  faq_question_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void KnowledgeAnswers_Answer::set_faq_question(const char* value) {
  ...
  faq_question_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.faq_question)
}
inline void KnowledgeAnswers_Answer::set_faq_question(const char* value,
    size_t size) {
  
  faq_question_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer.faq_question)
}
inline std::string* KnowledgeAnswers_Answer::_internal_mutable_faq_question() {
  
  return faq_question_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* KnowledgeAnswers_Answer::release_faq_question() {
  ...
  return faq_question_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void KnowledgeAnswers_Answer::set_allocated_faq_question(std::string* faq_question) {
  if (faq_question != nullptr) {
    
  } else {
    
  }
  faq_question_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), faq_question,
      GetArena());
...
inline const std::string& KnowledgeAnswers_Answer::_internal_answer() const {
  return answer_.Get();
}
inline void KnowledgeAnswers_Answer::_internal_set_answer(const std::string& value) {
...
inline std::string* KnowledgeAnswers_Answer::_internal_mutable_answer() {
...
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel KnowledgeAnswers_Answer::_internal_match_confidence_level() const {
...
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel KnowledgeAnswers_Answer::match_confidence_level() const {
  ...
  return _internal_match_confidence_level();
}
inline void KnowledgeAnswers_Answer::_internal_set_match_confidence_level(::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel value) {
...
inline void KnowledgeAnswers_Answer::set_match_confidence_level(::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer_MatchConfidenceLevel value) {
  _internal_set_match_confidence_level(value);
...
inline float KnowledgeAnswers_Answer::_internal_match_confidence() const {
...
inline float KnowledgeAnswers_Answer::match_confidence() const {
  ...
  return _internal_match_confidence();
}
inline void KnowledgeAnswers_Answer::_internal_set_match_confidence(float value) {
  
  match_confidence_ = value;
}
inline void KnowledgeAnswers_Answer::set_match_confidence(float value) {
  _internal_set_match_confidence(value);
...
// repeated .google.cloud.dialogflow.v2beta1.KnowledgeAnswers.Answer answers = 1;
inline int KnowledgeAnswers::_internal_answers_size() const {
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer >*
...
inline const ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer& KnowledgeAnswers::_internal_answers(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer* KnowledgeAnswers::_internal_add_answers() {
  return answers_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer* KnowledgeAnswers::add_answers() {
  ...
  return _internal_add_answers();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::KnowledgeAnswers_Answer >&
...
inline ::google::cloud::dialogflow::v2beta1::QueryParameters* StreamingDetectIntentRequest::_internal_mutable_query_params() {
...
inline ::google::cloud::dialogflow::v2beta1::QueryInput* StreamingDetectIntentRequest::_internal_mutable_query_input() {
...
inline ::google::cloud::dialogflow::v2beta1::OutputAudioConfig* StreamingDetectIntentRequest::_internal_mutable_output_audio_config() {
...
inline const PROTOBUF_NAMESPACE_ID::FieldMask& StreamingDetectIntentRequest::output_audio_config_mask() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest.output_audio_config_mask)
  return _internal_output_audio_config_mask();
}
inline void StreamingDetectIntentRequest::unsafe_arena_set_allocated_output_audio_config_mask(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest.output_audio_config_mask)
}
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* StreamingDetectIntentRequest::unsafe_arena_release_output_audio_config_mask() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest.output_audio_config_mask)
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* StreamingDetectIntentRequest::mutable_output_audio_config_mask() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest.output_audio_config_mask)
  return _internal_mutable_output_audio_config_mask();
}
inline void StreamingDetectIntentRequest::set_allocated_output_audio_config_mask(PROTOBUF_NAMESPACE_ID::FieldMask* output_audio_config_mask) {
  ...
  output_audio_config_mask_ = output_audio_config_mask;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.StreamingDetectIntentRequest.output_audio_config_mask)
}
...
inline const ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult& StreamingDetectIntentResponse::_internal_recognition_result() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult&>(
...
inline ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult* StreamingDetectIntentResponse::_internal_mutable_recognition_result() {
  
  if (recognition_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult>(GetArena());
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* StreamingDetectIntentResponse::_internal_mutable_query_result() {
...
// repeated .google.cloud.dialogflow.v2beta1.QueryResult alternative_query_results = 7;
inline int StreamingDetectIntentResponse::_internal_alternative_query_results_size() const {
  return alternative_query_results_.size();
}
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& StreamingDetectIntentResponse::_internal_alternative_query_results(int index) const {
  return alternative_query_results_.Get(index);
}
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* StreamingDetectIntentResponse::_internal_add_alternative_query_results() {
  return alternative_query_results_.Add();
}
...
inline ::google::cloud::dialogflow::v2beta1::OutputAudioConfig* StreamingDetectIntentResponse::_internal_mutable_output_audio_config() {
...
inline ::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult_MessageType StreamingRecognitionResult::_internal_message_type() const {
...
inline void StreamingRecognitionResult::_internal_set_message_type(::google::cloud::dialogflow::v2beta1::StreamingRecognitionResult_MessageType value) {
...
inline float StreamingRecognitionResult::stability() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.stability)
...
inline void StreamingRecognitionResult::set_stability(float value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.stability)
}
...
inline ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* StreamingRecognitionResult::mutable_speech_word_info(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_word_info)
  return speech_word_info_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SpeechWordInfo >*
StreamingRecognitionResult::mutable_speech_word_info() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_word_info)
  return &speech_word_info_;
}
inline const ::google::cloud::dialogflow::v2beta1::SpeechWordInfo& StreamingRecognitionResult::_internal_speech_word_info(int index) const {
  return speech_word_info_.Get(index);
}
inline const ::google::cloud::dialogflow::v2beta1::SpeechWordInfo& StreamingRecognitionResult::speech_word_info(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_word_info)
  return _internal_speech_word_info(index);
}
inline ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* StreamingRecognitionResult::_internal_add_speech_word_info() {
  return speech_word_info_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::SpeechWordInfo* StreamingRecognitionResult::add_speech_word_info() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_word_info)
  return _internal_add_speech_word_info();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::SpeechWordInfo >&
StreamingRecognitionResult::speech_word_info() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_word_info)
  return speech_word_info_;
}
...
inline const PROTOBUF_NAMESPACE_ID::Duration& StreamingRecognitionResult::speech_end_offset() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_end_offset)
...
inline void StreamingRecognitionResult::unsafe_arena_set_allocated_speech_end_offset(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_end_offset)
}
...
inline PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionResult::unsafe_arena_release_speech_end_offset() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_end_offset)
...
inline PROTOBUF_NAMESPACE_ID::Duration* StreamingRecognitionResult::mutable_speech_end_offset() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.speech_end_offset)
...
// .google.cloud.dialogflow.v2beta1.TelephonyDtmfEvents dtmf_digits = 5;
inline bool StreamingRecognitionResult::_internal_has_dtmf_digits() const {
  return this != internal_default_instance() && dtmf_digits_ != nullptr;
}
inline bool StreamingRecognitionResult::has_dtmf_digits() const {
  return _internal_has_dtmf_digits();
}
inline const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& StreamingRecognitionResult::_internal_dtmf_digits() const {
  const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* p = dtmf_digits_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents&>(
      ::google::cloud::dialogflow::v2beta1::_TelephonyDtmfEvents_default_instance_);
}
inline const ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents& StreamingRecognitionResult::dtmf_digits() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.dtmf_digits)
  return _internal_dtmf_digits();
}
inline void StreamingRecognitionResult::unsafe_arena_set_allocated_dtmf_digits(
    ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf_digits) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.dtmf_digits)
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* StreamingRecognitionResult::release_dtmf_digits() {
  
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* temp = dtmf_digits_;
...
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* StreamingRecognitionResult::unsafe_arena_release_dtmf_digits() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.dtmf_digits)
  
  ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* temp = dtmf_digits_;
  dtmf_digits_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* StreamingRecognitionResult::_internal_mutable_dtmf_digits() {
  
  if (dtmf_digits_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents>(GetArena());
    dtmf_digits_ = p;
  }
  return dtmf_digits_;
}
inline ::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* StreamingRecognitionResult::mutable_dtmf_digits() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.dtmf_digits)
  return _internal_mutable_dtmf_digits();
}
inline void StreamingRecognitionResult::set_allocated_dtmf_digits(::google::cloud::dialogflow::v2beta1::TelephonyDtmfEvents* dtmf_digits) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(dtmf_digits_);
  }
  ...
  dtmf_digits_ = dtmf_digits;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.StreamingRecognitionResult.dtmf_digits)
}
...
inline const ::google::cloud::dialogflow::v2beta1::Sentiment& SentimentAnalysisResult::_internal_query_text_sentiment() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::Sentiment&>(
...
inline ::google::cloud::dialogflow::v2beta1::Sentiment* SentimentAnalysisResult::_internal_mutable_query_text_sentiment() {
  
  if (query_text_sentiment_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Sentiment>(GetArena());
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fsession_2eproto
