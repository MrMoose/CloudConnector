...
#ifndef GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto
...
struct TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::google::cloud::dialogflow::v2beta1::ValidationError* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::ValidationError>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::ValidationResult* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::ValidationResult>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace cloud {
namespace dialogflow {
...
class ValidationError PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.ValidationError) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.ValidationError";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  void clear_severity();
  ::google::cloud::dialogflow::v2beta1::ValidationError_Severity severity() const;
  void set_severity(::google::cloud::dialogflow::v2beta1::ValidationError_Severity value);
  private:
  ::google::cloud::dialogflow::v2beta1::ValidationError_Severity _internal_severity() const;
  void _internal_set_severity(::google::cloud::dialogflow::v2beta1::ValidationError_Severity value);
  public:
 ...
 private:
  ...
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto;
};
// -------------------------------------------------------------------

class ValidationResult PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.ValidationResult) */ {
 public:
  ...
  // repeated .google.cloud.dialogflow.v2beta1.ValidationError validation_errors = 1;
  int validation_errors_size() const;
  private:
  int _internal_validation_errors_size() const;
  public:
  void clear_validation_errors();
  ::google::cloud::dialogflow::v2beta1::ValidationError* mutable_validation_errors(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::ValidationError >*
      mutable_validation_errors();
  private:
  const ::google::cloud::dialogflow::v2beta1::ValidationError& _internal_validation_errors(int index) const;
  ::google::cloud::dialogflow::v2beta1::ValidationError* _internal_add_validation_errors();
  public:
  const ::google::cloud::dialogflow::v2beta1::ValidationError& validation_errors(int index) const;
  ::google::cloud::dialogflow::v2beta1::ValidationError* add_validation_errors();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::ValidationError >&
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::ValidationError > validation_errors_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto;
};
// ===================================================================
...
inline ::google::cloud::dialogflow::v2beta1::ValidationError_Severity ValidationError::_internal_severity() const {
  return static_cast< ::google::cloud::dialogflow::v2beta1::ValidationError_Severity >(severity_);
}
inline ::google::cloud::dialogflow::v2beta1::ValidationError_Severity ValidationError::severity() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.ValidationError.severity)
  return _internal_severity();
}
inline void ValidationError::_internal_set_severity(::google::cloud::dialogflow::v2beta1::ValidationError_Severity value) {
  
  severity_ = value;
}
inline void ValidationError::set_severity(::google::cloud::dialogflow::v2beta1::ValidationError_Severity value) {
  _internal_set_severity(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.ValidationError.severity)
}
...
inline std::string* ValidationError::add_entries() {
  // @@protoc_insertion_point(field_add_mutable:google.cloud.dialogflow.v2beta1.ValidationError.entries)
...
inline const std::string& ValidationError::entries(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.ValidationError.entries)
  return _internal_entries(index);
}
inline std::string* ValidationError::mutable_entries(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.ValidationError.entries)
  return entries_.Mutable(index);
}
inline void ValidationError::set_entries(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.ValidationError.entries)
...
inline void ValidationError::set_entries(int index, const char* value) {
  ...
  entries_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.ValidationError.entries)
}
inline void ValidationError::set_entries(int index, const char* value, size_t size) {
  entries_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.ValidationError.entries)
}
...
inline void ValidationError::add_entries(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.ValidationError.entries)
}
...
inline void ValidationError::add_entries(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  entries_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:google.cloud.dialogflow.v2beta1.ValidationError.entries)
}
inline void ValidationError::add_entries(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:google.cloud.dialogflow.v2beta1.ValidationError.entries)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
ValidationError::entries() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.ValidationError.entries)
  return entries_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
ValidationError::mutable_entries() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.ValidationError.entries)
  return &entries_;
}
...
inline const std::string& ValidationError::error_message() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
  return _internal_error_message();
}
inline void ValidationError::set_error_message(const std::string& value) {
  _internal_set_error_message(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
}
inline std::string* ValidationError::mutable_error_message() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
...
inline void ValidationError::set_error_message(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
}
inline void ValidationError::set_error_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
}
inline void ValidationError::set_error_message(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
}
...
inline std::string* ValidationError::release_error_message() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
...
inline void ValidationError::set_allocated_error_message(std::string* error_message) {
  ...
  error_message_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), error_message,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.ValidationError.error_message)
}
...
inline ::google::cloud::dialogflow::v2beta1::ValidationError* ValidationResult::mutable_validation_errors(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.ValidationResult.validation_errors)
  return validation_errors_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::ValidationError >*
ValidationResult::mutable_validation_errors() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.ValidationResult.validation_errors)
  return &validation_errors_;
}
inline const ::google::cloud::dialogflow::v2beta1::ValidationError& ValidationResult::_internal_validation_errors(int index) const {
  return validation_errors_.Get(index);
}
inline const ::google::cloud::dialogflow::v2beta1::ValidationError& ValidationResult::validation_errors(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.ValidationResult.validation_errors)
  return _internal_validation_errors(index);
}
inline ::google::cloud::dialogflow::v2beta1::ValidationError* ValidationResult::_internal_add_validation_errors() {
  return validation_errors_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::ValidationError* ValidationResult::add_validation_errors() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.ValidationResult.validation_errors)
  return _internal_add_validation_errors();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::ValidationError >&
ValidationResult::validation_errors() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.ValidationResult.validation_errors)
  return validation_errors_;
}
...
template <> struct is_proto_enum< ::google::cloud::dialogflow::v2beta1::ValidationError_Severity> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::cloud::dialogflow::v2beta1::ValidationError_Severity>() {
  return ::google::cloud::dialogflow::v2beta1::ValidationError_Severity_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fvalidation_5fresult_2eproto
