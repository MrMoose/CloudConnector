...
#ifndef GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto
...
struct TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::google::cloud::dialogflow::v2beta1::Fulfillment* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Fulfillment>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Fulfillment_Feature>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService_RequestHeadersEntry_DoNotUse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService_RequestHeadersEntry_DoNotUse>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::GetFulfillmentRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::GetFulfillmentRequest>(Arena*);
template<> ::google::cloud::dialogflow::v2beta1::UpdateFulfillmentRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::UpdateFulfillmentRequest>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace cloud {
namespace dialogflow {
...
public:
  ...
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.RequestHeadersEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.RequestHeadersEntry.value");
 }
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& other) final;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto);
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto.file_level_metadata[0];
  }
...
class Fulfillment_GenericWebService PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService) */ {
 public:
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto_metadata_getter(kIndexInFileMessages);
  }
 ...
 private:
  ...
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto;
};
// -------------------------------------------------------------------

class Fulfillment_Feature PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.Fulfillment.Feature) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.Fulfillment.Feature";
  }
  protected:
  ...
  void clear_type();
  ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type type() const;
  void set_type(::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type value);
  private:
  ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type _internal_type() const;
  void _internal_set_type(::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type value);
  public:
...
class Fulfillment PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.Fulfillment) */ {
 public:
  ...
  public:
  void clear_features();
  ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* mutable_features(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature >*
      mutable_features();
  private:
  const ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature& _internal_features(int index) const;
  ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* _internal_add_features();
  public:
  const ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature& features(int index) const;
  ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* add_features();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature >&
      features() const;
  ...
  const ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService& generic_web_service() const;
  ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* release_generic_web_service();
  ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* mutable_generic_web_service();
  void set_allocated_generic_web_service(::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* generic_web_service);
  private:
  const ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService& _internal_generic_web_service() const;
  ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* _internal_mutable_generic_web_service();
  public:
  void unsafe_arena_set_allocated_generic_web_service(
      ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* generic_web_service);
  ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* unsafe_arena_release_generic_web_service();
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature > features_;
  ...
  union FulfillmentUnion {
    ...
    ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* generic_web_service_;
  } fulfillment_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class GetFulfillmentRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.GetFulfillmentRequest";
  }
  protected:
...
class UpdateFulfillmentRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest";
  }
  protected:
...
inline const std::string& Fulfillment_GenericWebService::uri() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
  return _internal_uri();
}
inline void Fulfillment_GenericWebService::set_uri(const std::string& value) {
  _internal_set_uri(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
}
inline std::string* Fulfillment_GenericWebService::mutable_uri() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
...
inline void Fulfillment_GenericWebService::set_uri(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
}
inline void Fulfillment_GenericWebService::set_uri(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
}
inline void Fulfillment_GenericWebService::set_uri(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
}
...
inline std::string* Fulfillment_GenericWebService::release_uri() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
...
inline void Fulfillment_GenericWebService::set_allocated_uri(std::string* uri) {
  ...
  uri_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), uri,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.uri)
}
...
inline const std::string& Fulfillment_GenericWebService::username() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
  return _internal_username();
}
inline void Fulfillment_GenericWebService::set_username(const std::string& value) {
  _internal_set_username(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
}
inline std::string* Fulfillment_GenericWebService::mutable_username() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
...
inline void Fulfillment_GenericWebService::set_username(std::string&& value) {
  ...
  username_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
}
inline void Fulfillment_GenericWebService::set_username(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
}
inline void Fulfillment_GenericWebService::set_username(const char* value,
    size_t size) {
  ...
  username_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
}
...
inline std::string* Fulfillment_GenericWebService::release_username() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
...
inline void Fulfillment_GenericWebService::set_allocated_username(std::string* username) {
  ...
  username_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), username,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.username)
}
...
inline const std::string& Fulfillment_GenericWebService::password() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
  return _internal_password();
}
inline void Fulfillment_GenericWebService::set_password(const std::string& value) {
  _internal_set_password(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
}
inline std::string* Fulfillment_GenericWebService::mutable_password() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
...
inline void Fulfillment_GenericWebService::set_password(std::string&& value) {
  ...
  password_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
}
inline void Fulfillment_GenericWebService::set_password(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
}
inline void Fulfillment_GenericWebService::set_password(const char* value,
    size_t size) {
  ...
  password_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
}
...
inline std::string* Fulfillment_GenericWebService::release_password() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
...
inline void Fulfillment_GenericWebService::set_allocated_password(std::string* password) {
  ...
  password_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), password,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.password)
}
...
Fulfillment_GenericWebService::request_headers() const {
  // @@protoc_insertion_point(field_map:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.request_headers)
...
Fulfillment_GenericWebService::mutable_request_headers() {
  // @@protoc_insertion_point(field_mutable_map:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.request_headers)
...
inline bool Fulfillment_GenericWebService::is_cloud_function() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.is_cloud_function)
...
inline void Fulfillment_GenericWebService::set_is_cloud_function(bool value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.GenericWebService.is_cloud_function)
}
...
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type Fulfillment_Feature::_internal_type() const {
  return static_cast< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type >(type_);
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type Fulfillment_Feature::type() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.Feature.type)
  return _internal_type();
}
inline void Fulfillment_Feature::_internal_set_type(::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type value) {
  
  type_ = value;
}
inline void Fulfillment_Feature::set_type(::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.Feature.type)
}
...
inline const std::string& Fulfillment::name() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.name)
  return _internal_name();
}
inline void Fulfillment::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.name)
}
inline std::string* Fulfillment::mutable_name() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.name)
...
inline void Fulfillment::set_name(std::string&& value) {
  ...
  name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.Fulfillment.name)
}
inline void Fulfillment::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.Fulfillment.name)
}
inline void Fulfillment::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.Fulfillment.name)
}
...
inline std::string* Fulfillment::release_name() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.name)
...
inline void Fulfillment::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.name)
}
...
inline const std::string& Fulfillment::display_name() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
  return _internal_display_name();
}
inline void Fulfillment::set_display_name(const std::string& value) {
  _internal_set_display_name(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
}
inline std::string* Fulfillment::mutable_display_name() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
...
inline void Fulfillment::set_display_name(std::string&& value) {
  ...
  display_name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
}
inline void Fulfillment::set_display_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
}
inline void Fulfillment::set_display_name(const char* value,
    size_t size) {
  ...
  display_name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
}
...
inline std::string* Fulfillment::release_display_name() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
...
inline void Fulfillment::set_allocated_display_name(std::string* display_name) {
  ...
  display_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), display_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.display_name)
}
...
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* Fulfillment::release_generic_web_service() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.Fulfillment.generic_web_service)
  if (_internal_has_generic_web_service()) {
    clear_has_fulfillment();
      ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* temp = fulfillment_.generic_web_service_;
    if (GetArena() != nullptr) {
...
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService& Fulfillment::_internal_generic_web_service() const {
  return _internal_has_generic_web_service()
      ? *fulfillment_.generic_web_service_
      : reinterpret_cast< ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService&>(::google::cloud::dialogflow::v2beta1::_Fulfillment_GenericWebService_default_instance_);
}
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService& Fulfillment::generic_web_service() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.generic_web_service)
  return _internal_generic_web_service();
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* Fulfillment::unsafe_arena_release_generic_web_service() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2beta1.Fulfillment.generic_web_service)
  if (_internal_has_generic_web_service()) {
    clear_has_fulfillment();
    ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* temp = fulfillment_.generic_web_service_;
    fulfillment_.generic_web_service_ = nullptr;
...
inline void Fulfillment::unsafe_arena_set_allocated_generic_web_service(::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* generic_web_service) {
  clear_fulfillment();
  if (generic_web_service) {
    set_has_generic_web_service();
    fulfillment_.generic_web_service_ = generic_web_service;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.Fulfillment.generic_web_service)
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* Fulfillment::_internal_mutable_generic_web_service() {
  if (!_internal_has_generic_web_service()) {
    clear_fulfillment();
    set_has_generic_web_service();
    fulfillment_.generic_web_service_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService >(GetArena());
  }
  return fulfillment_.generic_web_service_;
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_GenericWebService* Fulfillment::mutable_generic_web_service() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.generic_web_service)
...
inline bool Fulfillment::enabled() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.enabled)
...
inline void Fulfillment::set_enabled(bool value) {
  ...
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.Fulfillment.enabled)
}
...
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* Fulfillment::mutable_features(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.Fulfillment.features)
  return features_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature >*
Fulfillment::mutable_features() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.Fulfillment.features)
  return &features_;
}
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature& Fulfillment::_internal_features(int index) const {
  return features_.Get(index);
}
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature& Fulfillment::features(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.Fulfillment.features)
  return _internal_features(index);
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* Fulfillment::_internal_add_features() {
  return features_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature* Fulfillment::add_features() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.Fulfillment.features)
  return _internal_add_features();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature >&
Fulfillment::features() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.Fulfillment.features)
  return features_;
}
...
inline const std::string& GetFulfillmentRequest::name() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
  return _internal_name();
}
inline void GetFulfillmentRequest::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
}
inline std::string* GetFulfillmentRequest::mutable_name() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
  return _internal_mutable_name();
}
...
inline void GetFulfillmentRequest::set_name(std::string&& value) {
  ...
  name_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
}
inline void GetFulfillmentRequest::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
}
inline void GetFulfillmentRequest::set_name(const char* value,
    size_t size) {
  ...
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
}
...
inline std::string* GetFulfillmentRequest::release_name() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void GetFulfillmentRequest::set_allocated_name(std::string* name) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.GetFulfillmentRequest.name)
}
...
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment& UpdateFulfillmentRequest::_internal_fulfillment() const {
...
inline const ::google::cloud::dialogflow::v2beta1::Fulfillment& UpdateFulfillmentRequest::fulfillment() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.fulfillment)
...
inline void UpdateFulfillmentRequest::unsafe_arena_set_allocated_fulfillment(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.fulfillment)
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment* UpdateFulfillmentRequest::release_fulfillment() {
...
inline ::google::cloud::dialogflow::v2beta1::Fulfillment* UpdateFulfillmentRequest::unsafe_arena_release_fulfillment() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.fulfillment)
  
  ::google::cloud::dialogflow::v2beta1::Fulfillment* temp = fulfillment_;
  fulfillment_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2beta1::Fulfillment* UpdateFulfillmentRequest::_internal_mutable_fulfillment() {
...
inline ::google::cloud::dialogflow::v2beta1::Fulfillment* UpdateFulfillmentRequest::mutable_fulfillment() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.fulfillment)
  return _internal_mutable_fulfillment();
}
inline void UpdateFulfillmentRequest::set_allocated_fulfillment(::google::cloud::dialogflow::v2beta1::Fulfillment* fulfillment) {
  ...
  fulfillment_ = fulfillment;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.fulfillment)
}
...
inline const PROTOBUF_NAMESPACE_ID::FieldMask& UpdateFulfillmentRequest::update_mask() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.update_mask)
...
inline void UpdateFulfillmentRequest::unsafe_arena_set_allocated_update_mask(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.update_mask)
}
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* UpdateFulfillmentRequest::unsafe_arena_release_update_mask() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.update_mask)
...
inline PROTOBUF_NAMESPACE_ID::FieldMask* UpdateFulfillmentRequest::mutable_update_mask() {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.update_mask)
...
inline void UpdateFulfillmentRequest::set_allocated_update_mask(PROTOBUF_NAMESPACE_ID::FieldMask* update_mask) {
  ...
  update_mask_ = update_mask;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2beta1.UpdateFulfillmentRequest.update_mask)
}
...
template <> struct is_proto_enum< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type>() {
  return ::google::cloud::dialogflow::v2beta1::Fulfillment_Feature_Type_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2ffulfillment_2eproto
