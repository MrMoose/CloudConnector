...
#ifndef GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
...
struct TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto;
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
...
class WebhookRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.WebhookRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.WebhookRequest";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest* _internal_mutable_original_detect_intent_request();
  public:
 ...
 private:
  ...
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto;
};
// -------------------------------------------------------------------

class WebhookResponse PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.WebhookResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2beta1.WebhookResponse";
  }
  protected:
  ...
  enum : int {
    ...
    kLiveAgentHandoffFieldNumber = 7,
    kEndInteractionFieldNumber = 8,
  };
  ...
  ::google::cloud::dialogflow::v2beta1::EventInput* _internal_mutable_followup_event_input();
  public:
...
class OriginalDetectIntentRequest PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2beta1.OriginalDetectIntentRequest) */ {
 public:
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* WebhookRequest::_internal_mutable_query_result() {
...
// repeated .google.cloud.dialogflow.v2beta1.QueryResult alternative_query_results = 5;
inline int WebhookRequest::_internal_alternative_query_results_size() const {
...
inline const ::google::cloud::dialogflow::v2beta1::QueryResult& WebhookRequest::_internal_alternative_query_results(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::QueryResult* WebhookRequest::_internal_add_alternative_query_results() {
...
inline const ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest& WebhookRequest::_internal_original_detect_intent_request() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest&>(
...
inline ::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest* WebhookRequest::_internal_mutable_original_detect_intent_request() {
  
  if (original_detect_intent_request_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::OriginalDetectIntentRequest>(GetArena());
...
inline const ::google::cloud::dialogflow::v2beta1::Intent_Message& WebhookResponse::_internal_fulfillment_messages(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::Intent_Message* WebhookResponse::_internal_add_fulfillment_messages() {
...
inline const ::google::cloud::dialogflow::v2beta1::Context& WebhookResponse::_internal_output_contexts(int index) const {
...
inline ::google::cloud::dialogflow::v2beta1::Context* WebhookResponse::_internal_add_output_contexts() {
...
inline const ::google::cloud::dialogflow::v2beta1::EventInput& WebhookResponse::_internal_followup_event_input() const {
  ...
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2beta1::EventInput&>(
...
inline ::google::cloud::dialogflow::v2beta1::EventInput* WebhookResponse::_internal_mutable_followup_event_input() {
  
  if (followup_event_input_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2beta1::EventInput>(GetArena());
...
// bool live_agent_handoff = 7;
inline void WebhookResponse::clear_live_agent_handoff() {
  live_agent_handoff_ = false;
}
inline bool WebhookResponse::_internal_live_agent_handoff() const {
  return live_agent_handoff_;
}
inline bool WebhookResponse::live_agent_handoff() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.WebhookResponse.live_agent_handoff)
  return _internal_live_agent_handoff();
}
inline void WebhookResponse::_internal_set_live_agent_handoff(bool value) {
  
  live_agent_handoff_ = value;
}
inline void WebhookResponse::set_live_agent_handoff(bool value) {
  _internal_set_live_agent_handoff(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2beta1.WebhookResponse.live_agent_handoff)
}
...
inline bool WebhookResponse::_internal_end_interaction() const {
...
inline void WebhookResponse::_internal_set_end_interaction(bool value) {
...
inline ::google::cloud::dialogflow::v2beta1::SessionEntityType* WebhookResponse::mutable_session_entity_types(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2beta1.WebhookResponse.session_entity_types)
...
WebhookResponse::mutable_session_entity_types() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2beta1.WebhookResponse.session_entity_types)
  return &session_entity_types_;
}
inline const ::google::cloud::dialogflow::v2beta1::SessionEntityType& WebhookResponse::_internal_session_entity_types(int index) const {
  return session_entity_types_.Get(index);
}
inline const ::google::cloud::dialogflow::v2beta1::SessionEntityType& WebhookResponse::session_entity_types(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2beta1.WebhookResponse.session_entity_types)
  return _internal_session_entity_types(index);
}
inline ::google::cloud::dialogflow::v2beta1::SessionEntityType* WebhookResponse::_internal_add_session_entity_types() {
  return session_entity_types_.Add();
}
inline ::google::cloud::dialogflow::v2beta1::SessionEntityType* WebhookResponse::add_session_entity_types() {
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2beta1.WebhookResponse.session_entity_types)
...
WebhookResponse::session_entity_types() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2beta1.WebhookResponse.session_entity_types)
  return session_entity_types_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_google_2fcloud_2fdialogflow_2fv2beta1_2fwebhook_2eproto
