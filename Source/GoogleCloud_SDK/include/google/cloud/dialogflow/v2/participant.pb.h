...
struct InputTextConfigDefaultTypeInternal;
extern InputTextConfigDefaultTypeInternal _InputTextConfig_default_instance_;
...
struct StreamingAnalyzeContentRequestDefaultTypeInternal;
extern StreamingAnalyzeContentRequestDefaultTypeInternal _StreamingAnalyzeContentRequest_default_instance_;
class StreamingAnalyzeContentResponse;
struct StreamingAnalyzeContentResponseDefaultTypeInternal;
extern StreamingAnalyzeContentResponseDefaultTypeInternal _StreamingAnalyzeContentResponse_default_instance_;
...
template<> ::google::cloud::dialogflow::v2::InputTextConfig* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::InputTextConfig>(Arena*);
...
template<> ::google::cloud::dialogflow::v2::StreamingAnalyzeContentRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::StreamingAnalyzeContentRequest>(Arena*);
template<> ::google::cloud::dialogflow::v2::StreamingAnalyzeContentResponse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::StreamingAnalyzeContentResponse>(Arena*);
...
class Participant final :
 ...
 public:
  ...
  enum : int {
    ...
    kObfuscatedExternalUserIdFieldNumber = 7,
    kRoleFieldNumber = 2,
  };
  ...
  void clear_obfuscated_external_user_id();
  const std::string& obfuscated_external_user_id() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_obfuscated_external_user_id(ArgT0&& arg0, ArgT... args);
  std::string* mutable_obfuscated_external_user_id();
  PROTOBUF_NODISCARD std::string* release_obfuscated_external_user_id();
  void set_allocated_obfuscated_external_user_id(std::string* obfuscated_external_user_id);
  private:
  const std::string& _internal_obfuscated_external_user_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_obfuscated_external_user_id(const std::string& value);
  std::string* _internal_mutable_obfuscated_external_user_id();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr obfuscated_external_user_id_;
    int role_;
...
class StreamingAnalyzeContentRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest) */ {
 public:
  inline StreamingAnalyzeContentRequest() : StreamingAnalyzeContentRequest(nullptr) {}
  ~StreamingAnalyzeContentRequest() override;
  explicit PROTOBUF_CONSTEXPR StreamingAnalyzeContentRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StreamingAnalyzeContentRequest(const StreamingAnalyzeContentRequest& from);
  StreamingAnalyzeContentRequest(StreamingAnalyzeContentRequest&& from) noexcept
    : StreamingAnalyzeContentRequest() {
    *this = ::std::move(from);
  }

  inline StreamingAnalyzeContentRequest& operator=(const StreamingAnalyzeContentRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline StreamingAnalyzeContentRequest& operator=(StreamingAnalyzeContentRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StreamingAnalyzeContentRequest& default_instance() {
    return *internal_default_instance();
  }
  enum ConfigCase {
    kAudioConfig = 2,
  ...
  static inline const StreamingAnalyzeContentRequest* internal_default_instance() {
    return reinterpret_cast<const StreamingAnalyzeContentRequest*>(
               &_StreamingAnalyzeContentRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(StreamingAnalyzeContentRequest& a, StreamingAnalyzeContentRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(StreamingAnalyzeContentRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StreamingAnalyzeContentRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StreamingAnalyzeContentRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StreamingAnalyzeContentRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StreamingAnalyzeContentRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const StreamingAnalyzeContentRequest& from) {
    StreamingAnalyzeContentRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StreamingAnalyzeContentRequest* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest";
  }
  protected:
  explicit StreamingAnalyzeContentRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kParticipantFieldNumber = 1,
    kReplyAudioConfigFieldNumber = 4,
    kQueryParamsFieldNumber = 7,
    kAssistQueryParamsFieldNumber = 8,
    kCxParametersFieldNumber = 13,
    kEnablePartialAutomatedAgentReplyFieldNumber = 12,
    kAudioConfigFieldNumber = 2,
    kTextConfigFieldNumber = 3,
    kInputAudioFieldNumber = 5,
    kInputTextFieldNumber = 6,
    kInputDtmfFieldNumber = 9,
  };
  // string participant = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {
  void clear_participant();
  const std::string& participant() const;
  ...
  void clear_enable_partial_automated_agent_reply();
  bool enable_partial_automated_agent_reply() const;
  void set_enable_partial_automated_agent_reply(bool value);
  private:
  bool _internal_enable_partial_automated_agent_reply() const;
  void _internal_set_enable_partial_automated_agent_reply(bool value);
  public:
  ...
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::InputAudioConfig* release_audio_config();
  ...
  private:
  bool _internal_has_text_config() const;
  public:
  void clear_text_config();
  const ::google::cloud::dialogflow::v2::InputTextConfig& text_config() const;
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::InputTextConfig* release_text_config();
  ::google::cloud::dialogflow::v2::InputTextConfig* mutable_text_config();
  void set_allocated_text_config(::google::cloud::dialogflow::v2::InputTextConfig* text_config);
  private:
  const ::google::cloud::dialogflow::v2::InputTextConfig& _internal_text_config() const;
  ::google::cloud::dialogflow::v2::InputTextConfig* _internal_mutable_text_config();
  public:
  void unsafe_arena_set_allocated_text_config(
      ::google::cloud::dialogflow::v2::InputTextConfig* text_config);
  ::google::cloud::dialogflow::v2::InputTextConfig* unsafe_arena_release_text_config();
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_input_audio(ArgT0&& arg0, ArgT... args);
  std::string* mutable_input_audio();
  PROTOBUF_NODISCARD std::string* release_input_audio();
  void set_allocated_input_audio(std::string* input_audio);
  private:
  const std::string& _internal_input_audio() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_input_audio(const std::string& value);
  ...
  bool has_input_dtmf() const;
  private:
  bool _internal_has_input_dtmf() const;
  public:
  void clear_input_dtmf();
  const ::google::cloud::dialogflow::v2::TelephonyDtmfEvents& input_dtmf() const;
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* release_input_dtmf();
  ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* mutable_input_dtmf();
  void set_allocated_input_dtmf(::google::cloud::dialogflow::v2::TelephonyDtmfEvents* input_dtmf);
  private:
  const ::google::cloud::dialogflow::v2::TelephonyDtmfEvents& _internal_input_dtmf() const;
  ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* _internal_mutable_input_dtmf();
  public:
  void unsafe_arena_set_allocated_input_dtmf(
      ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* input_dtmf);
  ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* unsafe_arena_release_input_dtmf();
 ...
 private:
  ...
  void set_has_text_config();
  void set_has_input_audio();
  void set_has_input_text();
  void set_has_input_dtmf();
  ...
  struct Impl_ {
    ...
    ::google::cloud::dialogflow::v2::AssistQueryParameters* assist_query_params_;
    ::PROTOBUF_NAMESPACE_ID::Struct* cx_parameters_;
    bool enable_partial_automated_agent_reply_;
    union ConfigUnion {
      constexpr ConfigUnion() : _constinit_{} {}
        ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized _constinit_;
      ::google::cloud::dialogflow::v2::InputAudioConfig* audio_config_;
      ::google::cloud::dialogflow::v2::InputTextConfig* text_config_;
    } config_;
    union InputUnion {
      constexpr InputUnion() : _constinit_{} {}
        ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized _constinit_;
      ...
      ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* input_dtmf_;
    } input_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
class StreamingAnalyzeContentResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse) */ {
 public:
  inline StreamingAnalyzeContentResponse() : StreamingAnalyzeContentResponse(nullptr) {}
  ~StreamingAnalyzeContentResponse() override;
  explicit PROTOBUF_CONSTEXPR StreamingAnalyzeContentResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  StreamingAnalyzeContentResponse(const StreamingAnalyzeContentResponse& from);
  StreamingAnalyzeContentResponse(StreamingAnalyzeContentResponse&& from) noexcept
    : StreamingAnalyzeContentResponse() {
    *this = ::std::move(from);
  }

  inline StreamingAnalyzeContentResponse& operator=(const StreamingAnalyzeContentResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline StreamingAnalyzeContentResponse& operator=(StreamingAnalyzeContentResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const StreamingAnalyzeContentResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const StreamingAnalyzeContentResponse* internal_default_instance() {
    return reinterpret_cast<const StreamingAnalyzeContentResponse*>(
               &_StreamingAnalyzeContentResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(StreamingAnalyzeContentResponse& a, StreamingAnalyzeContentResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(StreamingAnalyzeContentResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(StreamingAnalyzeContentResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  StreamingAnalyzeContentResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StreamingAnalyzeContentResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const StreamingAnalyzeContentResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const StreamingAnalyzeContentResponse& from) {
    StreamingAnalyzeContentResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StreamingAnalyzeContentResponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse";
  }
  protected:
  explicit StreamingAnalyzeContentResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kHumanAgentSuggestionResultsFieldNumber = 7,
    kEndUserSuggestionResultsFieldNumber = 8,
    kReplyTextFieldNumber = 2,
    kRecognitionResultFieldNumber = 1,
    kReplyAudioFieldNumber = 3,
    kAutomatedAgentReplyFieldNumber = 4,
    kMessageFieldNumber = 6,
    kDtmfParametersFieldNumber = 10,
  };
  ...
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::StreamingRecognitionResult* release_recognition_result();
...
class AutomatedAgentReply final :
 ...
 public:
  ...
  void clear_cx_current_page();
  const std::string& cx_current_page() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_cx_current_page(ArgT0&& arg0, ArgT... args);
  std::string* mutable_cx_current_page();
  PROTOBUF_NODISCARD std::string* release_cx_current_page();
  void set_allocated_cx_current_page(std::string* cx_current_page);
  private:
  const std::string& _internal_cx_current_page() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_cx_current_page(const std::string& value);
  std::string* _internal_mutable_cx_current_page();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr cx_current_page_;
...
class InputTextConfig final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.InputTextConfig) */ {
 public:
  inline InputTextConfig() : InputTextConfig(nullptr) {}
  ~InputTextConfig() override;
  explicit PROTOBUF_CONSTEXPR InputTextConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  InputTextConfig(const InputTextConfig& from);
  InputTextConfig(InputTextConfig&& from) noexcept
    : InputTextConfig() {
    *this = ::std::move(from);
  }

  inline InputTextConfig& operator=(const InputTextConfig& from) {
    CopyFrom(from);
    return *this;
  }
  inline InputTextConfig& operator=(InputTextConfig&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const InputTextConfig& default_instance() {
    return *internal_default_instance();
  }
  static inline const InputTextConfig* internal_default_instance() {
    return reinterpret_cast<const InputTextConfig*>(
               &_InputTextConfig_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    27;

  friend void swap(InputTextConfig& a, InputTextConfig& b) {
    a.Swap(&b);
  }
  inline void Swap(InputTextConfig* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(InputTextConfig* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  InputTextConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<InputTextConfig>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const InputTextConfig& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const InputTextConfig& from) {
    InputTextConfig::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(InputTextConfig* other);
  ...
  protected:
  explicit InputTextConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
// string obfuscated_external_user_id = 7 [(.google.api.field_behavior) = OPTIONAL];
inline void Participant::clear_obfuscated_external_user_id() {
  _impl_.obfuscated_external_user_id_.ClearToEmpty();
}
inline const std::string& Participant::obfuscated_external_user_id() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.Participant.obfuscated_external_user_id)
  return _internal_obfuscated_external_user_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Participant::set_obfuscated_external_user_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.obfuscated_external_user_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.Participant.obfuscated_external_user_id)
}
inline std::string* Participant::mutable_obfuscated_external_user_id() {
  std::string* _s = _internal_mutable_obfuscated_external_user_id();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.Participant.obfuscated_external_user_id)
  return _s;
}
inline const std::string& Participant::_internal_obfuscated_external_user_id() const {
  return _impl_.obfuscated_external_user_id_.Get();
}
inline void Participant::_internal_set_obfuscated_external_user_id(const std::string& value) {
  
  _impl_.obfuscated_external_user_id_.Set(value, GetArenaForAllocation());
}
inline std::string* Participant::_internal_mutable_obfuscated_external_user_id() {
  
  return _impl_.obfuscated_external_user_id_.Mutable(GetArenaForAllocation());
}
inline std::string* Participant::release_obfuscated_external_user_id() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.Participant.obfuscated_external_user_id)
  return _impl_.obfuscated_external_user_id_.Release();
}
inline void Participant::set_allocated_obfuscated_external_user_id(std::string* obfuscated_external_user_id) {
  if (obfuscated_external_user_id != nullptr) {
    
  } else {
    
  }
  _impl_.obfuscated_external_user_id_.SetAllocated(obfuscated_external_user_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.obfuscated_external_user_id_.IsDefault()) {
    _impl_.obfuscated_external_user_id_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.Participant.obfuscated_external_user_id)
}
...
// string participant = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {
inline void StreamingAnalyzeContentRequest::clear_participant() {
  _impl_.participant_.ClearToEmpty();
}
inline const std::string& StreamingAnalyzeContentRequest::participant() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.participant)
  return _internal_participant();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void StreamingAnalyzeContentRequest::set_participant(ArgT0&& arg0, ArgT... args) {
 
 _impl_.participant_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.participant)
}
inline std::string* StreamingAnalyzeContentRequest::mutable_participant() {
  std::string* _s = _internal_mutable_participant();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.participant)
  return _s;
}
inline const std::string& StreamingAnalyzeContentRequest::_internal_participant() const {
  return _impl_.participant_.Get();
}
inline void StreamingAnalyzeContentRequest::_internal_set_participant(const std::string& value) {
  
  _impl_.participant_.Set(value, GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::_internal_mutable_participant() {
  
  return _impl_.participant_.Mutable(GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::release_participant() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.participant)
  return _impl_.participant_.Release();
}
inline void StreamingAnalyzeContentRequest::set_allocated_participant(std::string* participant) {
  if (participant != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.participant)
}

// .google.cloud.dialogflow.v2.InputAudioConfig audio_config = 2;
inline bool StreamingAnalyzeContentRequest::_internal_has_audio_config() const {
  return config_case() == kAudioConfig;
}
inline bool StreamingAnalyzeContentRequest::has_audio_config() const {
  return _internal_has_audio_config();
}
inline void StreamingAnalyzeContentRequest::set_has_audio_config() {
  _impl_._oneof_case_[0] = kAudioConfig;
}
inline ::google::cloud::dialogflow::v2::InputAudioConfig* StreamingAnalyzeContentRequest::release_audio_config() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.audio_config)
  if (_internal_has_audio_config()) {
    clear_has_config();
    ::google::cloud::dialogflow::v2::InputAudioConfig* temp = _impl_.config_.audio_config_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.config_.audio_config_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::google::cloud::dialogflow::v2::InputAudioConfig& StreamingAnalyzeContentRequest::_internal_audio_config() const {
  return _internal_has_audio_config()
      ? *_impl_.config_.audio_config_
...
inline const ::google::cloud::dialogflow::v2::InputAudioConfig& StreamingAnalyzeContentRequest::audio_config() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.audio_config)
  return _internal_audio_config();
}
inline ::google::cloud::dialogflow::v2::InputAudioConfig* StreamingAnalyzeContentRequest::unsafe_arena_release_audio_config() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.audio_config)
  if (_internal_has_audio_config()) {
    clear_has_config();
    ::google::cloud::dialogflow::v2::InputAudioConfig* temp = _impl_.config_.audio_config_;
    _impl_.config_.audio_config_ = nullptr;
...
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_audio_config(::google::cloud::dialogflow::v2::InputAudioConfig* audio_config) {
  clear_config();
  if (audio_config) {
    set_has_audio_config();
    _impl_.config_.audio_config_ = audio_config;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.audio_config)
}
inline ::google::cloud::dialogflow::v2::InputAudioConfig* StreamingAnalyzeContentRequest::_internal_mutable_audio_config() {
  if (!_internal_has_audio_config()) {
    clear_config();
    set_has_audio_config();
    _impl_.config_.audio_config_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2::InputAudioConfig >(GetArenaForAllocation());
  }
  return _impl_.config_.audio_config_;
}
inline ::google::cloud::dialogflow::v2::InputAudioConfig* StreamingAnalyzeContentRequest::mutable_audio_config() {
  ::google::cloud::dialogflow::v2::InputAudioConfig* _msg = _internal_mutable_audio_config();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.audio_config)
  return _msg;
}

// .google.cloud.dialogflow.v2.InputTextConfig text_config = 3;
inline bool StreamingAnalyzeContentRequest::_internal_has_text_config() const {
  return config_case() == kTextConfig;
}
inline bool StreamingAnalyzeContentRequest::has_text_config() const {
  return _internal_has_text_config();
}
inline void StreamingAnalyzeContentRequest::set_has_text_config() {
  _impl_._oneof_case_[0] = kTextConfig;
}
inline void StreamingAnalyzeContentRequest::clear_text_config() {
  if (_internal_has_text_config()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.config_.text_config_;
    }
    clear_has_config();
  }
}
inline ::google::cloud::dialogflow::v2::InputTextConfig* StreamingAnalyzeContentRequest::release_text_config() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.text_config)
  if (_internal_has_text_config()) {
    clear_has_config();
    ::google::cloud::dialogflow::v2::InputTextConfig* temp = _impl_.config_.text_config_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.config_.text_config_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::google::cloud::dialogflow::v2::InputTextConfig& StreamingAnalyzeContentRequest::_internal_text_config() const {
  return _internal_has_text_config()
      ? *_impl_.config_.text_config_
      : reinterpret_cast< ::google::cloud::dialogflow::v2::InputTextConfig&>(::google::cloud::dialogflow::v2::_InputTextConfig_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::InputTextConfig& StreamingAnalyzeContentRequest::text_config() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.text_config)
  return _internal_text_config();
}
inline ::google::cloud::dialogflow::v2::InputTextConfig* StreamingAnalyzeContentRequest::unsafe_arena_release_text_config() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.text_config)
  if (_internal_has_text_config()) {
    clear_has_config();
    ::google::cloud::dialogflow::v2::InputTextConfig* temp = _impl_.config_.text_config_;
    _impl_.config_.text_config_ = nullptr;
...
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_text_config(::google::cloud::dialogflow::v2::InputTextConfig* text_config) {
  clear_config();
  if (text_config) {
    set_has_text_config();
    _impl_.config_.text_config_ = text_config;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.text_config)
}
inline ::google::cloud::dialogflow::v2::InputTextConfig* StreamingAnalyzeContentRequest::_internal_mutable_text_config() {
  if (!_internal_has_text_config()) {
    clear_config();
    set_has_text_config();
    _impl_.config_.text_config_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2::InputTextConfig >(GetArenaForAllocation());
  }
  return _impl_.config_.text_config_;
}
inline ::google::cloud::dialogflow::v2::InputTextConfig* StreamingAnalyzeContentRequest::mutable_text_config() {
  ::google::cloud::dialogflow::v2::InputTextConfig* _msg = _internal_mutable_text_config();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.text_config)
  return _msg;
}

// .google.cloud.dialogflow.v2.OutputAudioConfig reply_audio_config = 4;
inline bool StreamingAnalyzeContentRequest::_internal_has_reply_audio_config() const {
  return this != internal_default_instance() && _impl_.reply_audio_config_ != nullptr;
}
inline bool StreamingAnalyzeContentRequest::has_reply_audio_config() const {
  return _internal_has_reply_audio_config();
}
inline const ::google::cloud::dialogflow::v2::OutputAudioConfig& StreamingAnalyzeContentRequest::_internal_reply_audio_config() const {
  const ::google::cloud::dialogflow::v2::OutputAudioConfig* p = _impl_.reply_audio_config_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::OutputAudioConfig&>(
      ::google::cloud::dialogflow::v2::_OutputAudioConfig_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::OutputAudioConfig& StreamingAnalyzeContentRequest::reply_audio_config() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.reply_audio_config)
  return _internal_reply_audio_config();
}
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_reply_audio_config(
    ::google::cloud::dialogflow::v2::OutputAudioConfig* reply_audio_config) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.reply_audio_config_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.reply_audio_config)
}
inline ::google::cloud::dialogflow::v2::OutputAudioConfig* StreamingAnalyzeContentRequest::release_reply_audio_config() {
...
inline ::google::cloud::dialogflow::v2::OutputAudioConfig* StreamingAnalyzeContentRequest::unsafe_arena_release_reply_audio_config() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.reply_audio_config)
  
  ::google::cloud::dialogflow::v2::OutputAudioConfig* temp = _impl_.reply_audio_config_;
  _impl_.reply_audio_config_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::OutputAudioConfig* StreamingAnalyzeContentRequest::_internal_mutable_reply_audio_config() {
...
inline ::google::cloud::dialogflow::v2::OutputAudioConfig* StreamingAnalyzeContentRequest::mutable_reply_audio_config() {
  ::google::cloud::dialogflow::v2::OutputAudioConfig* _msg = _internal_mutable_reply_audio_config();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.reply_audio_config)
  return _msg;
}
inline void StreamingAnalyzeContentRequest::set_allocated_reply_audio_config(::google::cloud::dialogflow::v2::OutputAudioConfig* reply_audio_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.reply_audio_config_);
  }
  ...
  _impl_.reply_audio_config_ = reply_audio_config;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.reply_audio_config)
}

// bytes input_audio = 5;
inline bool StreamingAnalyzeContentRequest::_internal_has_input_audio() const {
  return input_case() == kInputAudio;
}
inline bool StreamingAnalyzeContentRequest::has_input_audio() const {
  return _internal_has_input_audio();
}
inline void StreamingAnalyzeContentRequest::set_has_input_audio() {
  _impl_._oneof_case_[1] = kInputAudio;
}
inline void StreamingAnalyzeContentRequest::clear_input_audio() {
  if (_internal_has_input_audio()) {
    _impl_.input_.input_audio_.Destroy();
    clear_has_input();
  }
}
inline const std::string& StreamingAnalyzeContentRequest::input_audio() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_audio)
  return _internal_input_audio();
}
template <typename ArgT0, typename... ArgT>
inline void StreamingAnalyzeContentRequest::set_input_audio(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_input_audio()) {
    clear_input();
    set_has_input_audio();
    _impl_.input_.input_audio_.InitDefault();
  }
  _impl_.input_.input_audio_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_audio)
}
inline std::string* StreamingAnalyzeContentRequest::mutable_input_audio() {
  std::string* _s = _internal_mutable_input_audio();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_audio)
  return _s;
}
inline const std::string& StreamingAnalyzeContentRequest::_internal_input_audio() const {
  if (_internal_has_input_audio()) {
    return _impl_.input_.input_audio_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void StreamingAnalyzeContentRequest::_internal_set_input_audio(const std::string& value) {
  if (!_internal_has_input_audio()) {
    clear_input();
    set_has_input_audio();
    _impl_.input_.input_audio_.InitDefault();
  }
  _impl_.input_.input_audio_.Set(value, GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::_internal_mutable_input_audio() {
  if (!_internal_has_input_audio()) {
    clear_input();
    set_has_input_audio();
    _impl_.input_.input_audio_.InitDefault();
  }
  return _impl_.input_.input_audio_.Mutable(      GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::release_input_audio() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_audio)
  if (_internal_has_input_audio()) {
    clear_has_input();
    return _impl_.input_.input_audio_.Release();
  } else {
    return nullptr;
  }
}
inline void StreamingAnalyzeContentRequest::set_allocated_input_audio(std::string* input_audio) {
  if (has_input()) {
    clear_input();
  }
  if (input_audio != nullptr) {
    set_has_input_audio();
    _impl_.input_.input_audio_.InitAllocated(input_audio, GetArenaForAllocation());
  }
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_audio)
}

// string input_text = 6;
inline bool StreamingAnalyzeContentRequest::_internal_has_input_text() const {
  return input_case() == kInputText;
}
inline bool StreamingAnalyzeContentRequest::has_input_text() const {
  return _internal_has_input_text();
}
inline void StreamingAnalyzeContentRequest::set_has_input_text() {
  _impl_._oneof_case_[1] = kInputText;
}
inline void StreamingAnalyzeContentRequest::clear_input_text() {
  if (_internal_has_input_text()) {
    _impl_.input_.input_text_.Destroy();
    clear_has_input();
  }
}
inline const std::string& StreamingAnalyzeContentRequest::input_text() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_text)
  return _internal_input_text();
}
template <typename ArgT0, typename... ArgT>
inline void StreamingAnalyzeContentRequest::set_input_text(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_input_text()) {
    clear_input();
    set_has_input_text();
    _impl_.input_.input_text_.InitDefault();
  }
  _impl_.input_.input_text_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_text)
}
inline std::string* StreamingAnalyzeContentRequest::mutable_input_text() {
  std::string* _s = _internal_mutable_input_text();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_text)
  return _s;
}
inline const std::string& StreamingAnalyzeContentRequest::_internal_input_text() const {
  if (_internal_has_input_text()) {
    return _impl_.input_.input_text_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void StreamingAnalyzeContentRequest::_internal_set_input_text(const std::string& value) {
  if (!_internal_has_input_text()) {
    clear_input();
    set_has_input_text();
    _impl_.input_.input_text_.InitDefault();
  }
  _impl_.input_.input_text_.Set(value, GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::_internal_mutable_input_text() {
  if (!_internal_has_input_text()) {
    clear_input();
    set_has_input_text();
    _impl_.input_.input_text_.InitDefault();
  }
  return _impl_.input_.input_text_.Mutable(      GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentRequest::release_input_text() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_text)
  if (_internal_has_input_text()) {
    clear_has_input();
    return _impl_.input_.input_text_.Release();
  } else {
    return nullptr;
  }
}
inline void StreamingAnalyzeContentRequest::set_allocated_input_text(std::string* input_text) {
  if (has_input()) {
    clear_input();
  }
  if (input_text != nullptr) {
    set_has_input_text();
    _impl_.input_.input_text_.InitAllocated(input_text, GetArenaForAllocation());
  }
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_text)
}

// .google.cloud.dialogflow.v2.TelephonyDtmfEvents input_dtmf = 9;
inline bool StreamingAnalyzeContentRequest::_internal_has_input_dtmf() const {
  return input_case() == kInputDtmf;
}
inline bool StreamingAnalyzeContentRequest::has_input_dtmf() const {
  return _internal_has_input_dtmf();
}
inline void StreamingAnalyzeContentRequest::set_has_input_dtmf() {
  _impl_._oneof_case_[1] = kInputDtmf;
}
inline ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* StreamingAnalyzeContentRequest::release_input_dtmf() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_dtmf)
  if (_internal_has_input_dtmf()) {
    clear_has_input();
    ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* temp = _impl_.input_.input_dtmf_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.input_.input_dtmf_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::google::cloud::dialogflow::v2::TelephonyDtmfEvents& StreamingAnalyzeContentRequest::_internal_input_dtmf() const {
  return _internal_has_input_dtmf()
      ? *_impl_.input_.input_dtmf_
      : reinterpret_cast< ::google::cloud::dialogflow::v2::TelephonyDtmfEvents&>(::google::cloud::dialogflow::v2::_TelephonyDtmfEvents_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::TelephonyDtmfEvents& StreamingAnalyzeContentRequest::input_dtmf() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_dtmf)
  return _internal_input_dtmf();
}
inline ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* StreamingAnalyzeContentRequest::unsafe_arena_release_input_dtmf() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_dtmf)
  if (_internal_has_input_dtmf()) {
    clear_has_input();
    ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* temp = _impl_.input_.input_dtmf_;
    _impl_.input_.input_dtmf_ = nullptr;
...
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_input_dtmf(::google::cloud::dialogflow::v2::TelephonyDtmfEvents* input_dtmf) {
  clear_input();
  if (input_dtmf) {
    set_has_input_dtmf();
    _impl_.input_.input_dtmf_ = input_dtmf;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_dtmf)
}
inline ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* StreamingAnalyzeContentRequest::_internal_mutable_input_dtmf() {
  if (!_internal_has_input_dtmf()) {
    clear_input();
    set_has_input_dtmf();
    _impl_.input_.input_dtmf_ = CreateMaybeMessage< ::google::cloud::dialogflow::v2::TelephonyDtmfEvents >(GetArenaForAllocation());
  }
  return _impl_.input_.input_dtmf_;
}
inline ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* StreamingAnalyzeContentRequest::mutable_input_dtmf() {
  ::google::cloud::dialogflow::v2::TelephonyDtmfEvents* _msg = _internal_mutable_input_dtmf();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.input_dtmf)
  return _msg;
}

// .google.cloud.dialogflow.v2.QueryParameters query_params = 7;
inline bool StreamingAnalyzeContentRequest::_internal_has_query_params() const {
  return this != internal_default_instance() && _impl_.query_params_ != nullptr;
}
inline bool StreamingAnalyzeContentRequest::has_query_params() const {
  return _internal_has_query_params();
}
inline const ::google::cloud::dialogflow::v2::QueryParameters& StreamingAnalyzeContentRequest::_internal_query_params() const {
  const ::google::cloud::dialogflow::v2::QueryParameters* p = _impl_.query_params_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::QueryParameters&>(
      ::google::cloud::dialogflow::v2::_QueryParameters_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::QueryParameters& StreamingAnalyzeContentRequest::query_params() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.query_params)
  return _internal_query_params();
}
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_query_params(
    ::google::cloud::dialogflow::v2::QueryParameters* query_params) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.query_params_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.query_params)
}
inline ::google::cloud::dialogflow::v2::QueryParameters* StreamingAnalyzeContentRequest::release_query_params() {
...
inline ::google::cloud::dialogflow::v2::QueryParameters* StreamingAnalyzeContentRequest::unsafe_arena_release_query_params() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.query_params)
  
  ::google::cloud::dialogflow::v2::QueryParameters* temp = _impl_.query_params_;
  _impl_.query_params_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::QueryParameters* StreamingAnalyzeContentRequest::_internal_mutable_query_params() {
...
inline ::google::cloud::dialogflow::v2::QueryParameters* StreamingAnalyzeContentRequest::mutable_query_params() {
  ::google::cloud::dialogflow::v2::QueryParameters* _msg = _internal_mutable_query_params();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.query_params)
  return _msg;
}
inline void StreamingAnalyzeContentRequest::set_allocated_query_params(::google::cloud::dialogflow::v2::QueryParameters* query_params) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.query_params_);
  }
  ...
  _impl_.query_params_ = query_params;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.query_params)
}

// .google.cloud.dialogflow.v2.AssistQueryParameters assist_query_params = 8;
inline bool StreamingAnalyzeContentRequest::_internal_has_assist_query_params() const {
  return this != internal_default_instance() && _impl_.assist_query_params_ != nullptr;
}
inline bool StreamingAnalyzeContentRequest::has_assist_query_params() const {
  return _internal_has_assist_query_params();
}
inline void StreamingAnalyzeContentRequest::clear_assist_query_params() {
  if (GetArenaForAllocation() == nullptr && _impl_.assist_query_params_ != nullptr) {
    delete _impl_.assist_query_params_;
  }
  _impl_.assist_query_params_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::AssistQueryParameters& StreamingAnalyzeContentRequest::_internal_assist_query_params() const {
  const ::google::cloud::dialogflow::v2::AssistQueryParameters* p = _impl_.assist_query_params_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::AssistQueryParameters&>(
      ::google::cloud::dialogflow::v2::_AssistQueryParameters_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::AssistQueryParameters& StreamingAnalyzeContentRequest::assist_query_params() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.assist_query_params)
  return _internal_assist_query_params();
}
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_assist_query_params(
    ::google::cloud::dialogflow::v2::AssistQueryParameters* assist_query_params) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.assist_query_params_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.assist_query_params)
}
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* StreamingAnalyzeContentRequest::release_assist_query_params() {
...
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* StreamingAnalyzeContentRequest::unsafe_arena_release_assist_query_params() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.assist_query_params)
  
  ::google::cloud::dialogflow::v2::AssistQueryParameters* temp = _impl_.assist_query_params_;
  _impl_.assist_query_params_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* StreamingAnalyzeContentRequest::_internal_mutable_assist_query_params() {
...
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* StreamingAnalyzeContentRequest::mutable_assist_query_params() {
  ::google::cloud::dialogflow::v2::AssistQueryParameters* _msg = _internal_mutable_assist_query_params();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.assist_query_params)
  return _msg;
}
inline void StreamingAnalyzeContentRequest::set_allocated_assist_query_params(::google::cloud::dialogflow::v2::AssistQueryParameters* assist_query_params) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.assist_query_params_;
  }
  ...
  _impl_.assist_query_params_ = assist_query_params;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.assist_query_params)
}

// .google.protobuf.Struct cx_parameters = 13;
inline bool StreamingAnalyzeContentRequest::_internal_has_cx_parameters() const {
  return this != internal_default_instance() && _impl_.cx_parameters_ != nullptr;
}
inline bool StreamingAnalyzeContentRequest::has_cx_parameters() const {
  return _internal_has_cx_parameters();
}
inline const ::PROTOBUF_NAMESPACE_ID::Struct& StreamingAnalyzeContentRequest::_internal_cx_parameters() const {
  const ::PROTOBUF_NAMESPACE_ID::Struct* p = _impl_.cx_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Struct&>(
      ::PROTOBUF_NAMESPACE_ID::_Struct_default_instance_);
}
inline const ::PROTOBUF_NAMESPACE_ID::Struct& StreamingAnalyzeContentRequest::cx_parameters() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.cx_parameters)
  return _internal_cx_parameters();
}
inline void StreamingAnalyzeContentRequest::unsafe_arena_set_allocated_cx_parameters(
    ::PROTOBUF_NAMESPACE_ID::Struct* cx_parameters) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.cx_parameters_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.cx_parameters)
}
inline ::PROTOBUF_NAMESPACE_ID::Struct* StreamingAnalyzeContentRequest::release_cx_parameters() {
...
inline ::PROTOBUF_NAMESPACE_ID::Struct* StreamingAnalyzeContentRequest::unsafe_arena_release_cx_parameters() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.cx_parameters)
  
  ::PROTOBUF_NAMESPACE_ID::Struct* temp = _impl_.cx_parameters_;
  _impl_.cx_parameters_ = nullptr;
  return temp;
}
inline ::PROTOBUF_NAMESPACE_ID::Struct* StreamingAnalyzeContentRequest::_internal_mutable_cx_parameters() {
...
inline ::PROTOBUF_NAMESPACE_ID::Struct* StreamingAnalyzeContentRequest::mutable_cx_parameters() {
  ::PROTOBUF_NAMESPACE_ID::Struct* _msg = _internal_mutable_cx_parameters();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.cx_parameters)
  return _msg;
}
inline void StreamingAnalyzeContentRequest::set_allocated_cx_parameters(::PROTOBUF_NAMESPACE_ID::Struct* cx_parameters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.cx_parameters_);
  }
  ...
  _impl_.cx_parameters_ = cx_parameters;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.cx_parameters)
}

// bool enable_partial_automated_agent_reply = 12;
inline void StreamingAnalyzeContentRequest::clear_enable_partial_automated_agent_reply() {
  _impl_.enable_partial_automated_agent_reply_ = false;
}
inline bool StreamingAnalyzeContentRequest::_internal_enable_partial_automated_agent_reply() const {
  return _impl_.enable_partial_automated_agent_reply_;
}
inline bool StreamingAnalyzeContentRequest::enable_partial_automated_agent_reply() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.enable_partial_automated_agent_reply)
  return _internal_enable_partial_automated_agent_reply();
}
inline void StreamingAnalyzeContentRequest::_internal_set_enable_partial_automated_agent_reply(bool value) {
  
  _impl_.enable_partial_automated_agent_reply_ = value;
}
inline void StreamingAnalyzeContentRequest::set_enable_partial_automated_agent_reply(bool value) {
  _internal_set_enable_partial_automated_agent_reply(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.StreamingAnalyzeContentRequest.enable_partial_automated_agent_reply)
}

inline bool StreamingAnalyzeContentRequest::has_config() const {
  return config_case() != CONFIG_NOT_SET;
}
inline void StreamingAnalyzeContentRequest::clear_has_config() {
  _impl_._oneof_case_[0] = CONFIG_NOT_SET;
}
inline bool StreamingAnalyzeContentRequest::has_input() const {
  return input_case() != INPUT_NOT_SET;
}
inline void StreamingAnalyzeContentRequest::clear_has_input() {
  _impl_._oneof_case_[1] = INPUT_NOT_SET;
}
inline StreamingAnalyzeContentRequest::ConfigCase StreamingAnalyzeContentRequest::config_case() const {
  return StreamingAnalyzeContentRequest::ConfigCase(_impl_._oneof_case_[0]);
}
inline StreamingAnalyzeContentRequest::InputCase StreamingAnalyzeContentRequest::input_case() const {
  return StreamingAnalyzeContentRequest::InputCase(_impl_._oneof_case_[1]);
}
// -------------------------------------------------------------------
...
// .google.cloud.dialogflow.v2.StreamingRecognitionResult recognition_result = 1;
inline bool StreamingAnalyzeContentResponse::_internal_has_recognition_result() const {
  return this != internal_default_instance() && _impl_.recognition_result_ != nullptr;
}
inline bool StreamingAnalyzeContentResponse::has_recognition_result() const {
  return _internal_has_recognition_result();
}
inline const ::google::cloud::dialogflow::v2::StreamingRecognitionResult& StreamingAnalyzeContentResponse::_internal_recognition_result() const {
  const ::google::cloud::dialogflow::v2::StreamingRecognitionResult* p = _impl_.recognition_result_;
...
inline const ::google::cloud::dialogflow::v2::StreamingRecognitionResult& StreamingAnalyzeContentResponse::recognition_result() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.recognition_result)
  return _internal_recognition_result();
}
inline void StreamingAnalyzeContentResponse::unsafe_arena_set_allocated_recognition_result(
    ::google::cloud::dialogflow::v2::StreamingRecognitionResult* recognition_result) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.recognition_result)
}
inline ::google::cloud::dialogflow::v2::StreamingRecognitionResult* StreamingAnalyzeContentResponse::release_recognition_result() {
  
  ::google::cloud::dialogflow::v2::StreamingRecognitionResult* temp = _impl_.recognition_result_;
...
inline ::google::cloud::dialogflow::v2::StreamingRecognitionResult* StreamingAnalyzeContentResponse::unsafe_arena_release_recognition_result() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.recognition_result)
  
  ::google::cloud::dialogflow::v2::StreamingRecognitionResult* temp = _impl_.recognition_result_;
  _impl_.recognition_result_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::StreamingRecognitionResult* StreamingAnalyzeContentResponse::_internal_mutable_recognition_result() {
  
  if (_impl_.recognition_result_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2::StreamingRecognitionResult>(GetArenaForAllocation());
    _impl_.recognition_result_ = p;
  }
  return _impl_.recognition_result_;
}
inline ::google::cloud::dialogflow::v2::StreamingRecognitionResult* StreamingAnalyzeContentResponse::mutable_recognition_result() {
  ::google::cloud::dialogflow::v2::StreamingRecognitionResult* _msg = _internal_mutable_recognition_result();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.recognition_result)
  return _msg;
}
inline void StreamingAnalyzeContentResponse::set_allocated_recognition_result(::google::cloud::dialogflow::v2::StreamingRecognitionResult* recognition_result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.recognition_result_);
  }
  if (recognition_result) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(recognition_result));
    if (message_arena != submessage_arena) {
  ...
  _impl_.recognition_result_ = recognition_result;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.recognition_result)
}

// string reply_text = 2;
inline void StreamingAnalyzeContentResponse::clear_reply_text() {
  _impl_.reply_text_.ClearToEmpty();
}
inline const std::string& StreamingAnalyzeContentResponse::reply_text() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_text)
  return _internal_reply_text();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void StreamingAnalyzeContentResponse::set_reply_text(ArgT0&& arg0, ArgT... args) {
 
 _impl_.reply_text_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_text)
}
inline std::string* StreamingAnalyzeContentResponse::mutable_reply_text() {
  std::string* _s = _internal_mutable_reply_text();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_text)
  return _s;
}
inline const std::string& StreamingAnalyzeContentResponse::_internal_reply_text() const {
  return _impl_.reply_text_.Get();
}
inline void StreamingAnalyzeContentResponse::_internal_set_reply_text(const std::string& value) {
  
  _impl_.reply_text_.Set(value, GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentResponse::_internal_mutable_reply_text() {
  
  return _impl_.reply_text_.Mutable(GetArenaForAllocation());
}
inline std::string* StreamingAnalyzeContentResponse::release_reply_text() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_text)
  return _impl_.reply_text_.Release();
}
inline void StreamingAnalyzeContentResponse::set_allocated_reply_text(std::string* reply_text) {
  if (reply_text != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_text)
}

// .google.cloud.dialogflow.v2.OutputAudio reply_audio = 3;
inline bool StreamingAnalyzeContentResponse::_internal_has_reply_audio() const {
  return this != internal_default_instance() && _impl_.reply_audio_ != nullptr;
}
inline bool StreamingAnalyzeContentResponse::has_reply_audio() const {
  return _internal_has_reply_audio();
}
inline void StreamingAnalyzeContentResponse::clear_reply_audio() {
  if (GetArenaForAllocation() == nullptr && _impl_.reply_audio_ != nullptr) {
    delete _impl_.reply_audio_;
  }
  _impl_.reply_audio_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::OutputAudio& StreamingAnalyzeContentResponse::_internal_reply_audio() const {
  const ::google::cloud::dialogflow::v2::OutputAudio* p = _impl_.reply_audio_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::OutputAudio&>(
      ::google::cloud::dialogflow::v2::_OutputAudio_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::OutputAudio& StreamingAnalyzeContentResponse::reply_audio() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_audio)
  return _internal_reply_audio();
}
inline void StreamingAnalyzeContentResponse::unsafe_arena_set_allocated_reply_audio(
    ::google::cloud::dialogflow::v2::OutputAudio* reply_audio) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.reply_audio_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_audio)
}
inline ::google::cloud::dialogflow::v2::OutputAudio* StreamingAnalyzeContentResponse::release_reply_audio() {
...
inline ::google::cloud::dialogflow::v2::OutputAudio* StreamingAnalyzeContentResponse::unsafe_arena_release_reply_audio() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_audio)
  
  ::google::cloud::dialogflow::v2::OutputAudio* temp = _impl_.reply_audio_;
  _impl_.reply_audio_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::OutputAudio* StreamingAnalyzeContentResponse::_internal_mutable_reply_audio() {
...
inline ::google::cloud::dialogflow::v2::OutputAudio* StreamingAnalyzeContentResponse::mutable_reply_audio() {
  ::google::cloud::dialogflow::v2::OutputAudio* _msg = _internal_mutable_reply_audio();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_audio)
  return _msg;
}
inline void StreamingAnalyzeContentResponse::set_allocated_reply_audio(::google::cloud::dialogflow::v2::OutputAudio* reply_audio) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.reply_audio_;
  }
  ...
  _impl_.reply_audio_ = reply_audio;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.reply_audio)
}

// .google.cloud.dialogflow.v2.AutomatedAgentReply automated_agent_reply = 4;
inline bool StreamingAnalyzeContentResponse::_internal_has_automated_agent_reply() const {
  return this != internal_default_instance() && _impl_.automated_agent_reply_ != nullptr;
}
inline bool StreamingAnalyzeContentResponse::has_automated_agent_reply() const {
  return _internal_has_automated_agent_reply();
}
inline void StreamingAnalyzeContentResponse::clear_automated_agent_reply() {
  if (GetArenaForAllocation() == nullptr && _impl_.automated_agent_reply_ != nullptr) {
    delete _impl_.automated_agent_reply_;
  }
  _impl_.automated_agent_reply_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::AutomatedAgentReply& StreamingAnalyzeContentResponse::_internal_automated_agent_reply() const {
  const ::google::cloud::dialogflow::v2::AutomatedAgentReply* p = _impl_.automated_agent_reply_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::AutomatedAgentReply&>(
      ::google::cloud::dialogflow::v2::_AutomatedAgentReply_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::AutomatedAgentReply& StreamingAnalyzeContentResponse::automated_agent_reply() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.automated_agent_reply)
  return _internal_automated_agent_reply();
}
inline void StreamingAnalyzeContentResponse::unsafe_arena_set_allocated_automated_agent_reply(
    ::google::cloud::dialogflow::v2::AutomatedAgentReply* automated_agent_reply) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.automated_agent_reply_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.automated_agent_reply)
}
inline ::google::cloud::dialogflow::v2::AutomatedAgentReply* StreamingAnalyzeContentResponse::release_automated_agent_reply() {
...
inline ::google::cloud::dialogflow::v2::AutomatedAgentReply* StreamingAnalyzeContentResponse::unsafe_arena_release_automated_agent_reply() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.automated_agent_reply)
  
  ::google::cloud::dialogflow::v2::AutomatedAgentReply* temp = _impl_.automated_agent_reply_;
  _impl_.automated_agent_reply_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::AutomatedAgentReply* StreamingAnalyzeContentResponse::_internal_mutable_automated_agent_reply() {
...
inline ::google::cloud::dialogflow::v2::AutomatedAgentReply* StreamingAnalyzeContentResponse::mutable_automated_agent_reply() {
  ::google::cloud::dialogflow::v2::AutomatedAgentReply* _msg = _internal_mutable_automated_agent_reply();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.automated_agent_reply)
  return _msg;
}
inline void StreamingAnalyzeContentResponse::set_allocated_automated_agent_reply(::google::cloud::dialogflow::v2::AutomatedAgentReply* automated_agent_reply) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.automated_agent_reply_;
  }
  ...
  _impl_.automated_agent_reply_ = automated_agent_reply;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.automated_agent_reply)
}

// .google.cloud.dialogflow.v2.Message message = 6;
inline bool StreamingAnalyzeContentResponse::_internal_has_message() const {
  return this != internal_default_instance() && _impl_.message_ != nullptr;
}
inline bool StreamingAnalyzeContentResponse::has_message() const {
  return _internal_has_message();
}
inline void StreamingAnalyzeContentResponse::clear_message() {
  if (GetArenaForAllocation() == nullptr && _impl_.message_ != nullptr) {
    delete _impl_.message_;
  }
  _impl_.message_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::Message& StreamingAnalyzeContentResponse::_internal_message() const {
  const ::google::cloud::dialogflow::v2::Message* p = _impl_.message_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::Message&>(
      ::google::cloud::dialogflow::v2::_Message_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::Message& StreamingAnalyzeContentResponse::message() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.message)
  return _internal_message();
}
inline void StreamingAnalyzeContentResponse::unsafe_arena_set_allocated_message(
    ::google::cloud::dialogflow::v2::Message* message) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.message_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.message)
}
inline ::google::cloud::dialogflow::v2::Message* StreamingAnalyzeContentResponse::release_message() {
...
inline ::google::cloud::dialogflow::v2::Message* StreamingAnalyzeContentResponse::unsafe_arena_release_message() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.message)
  
  ::google::cloud::dialogflow::v2::Message* temp = _impl_.message_;
  _impl_.message_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::Message* StreamingAnalyzeContentResponse::_internal_mutable_message() {
...
inline ::google::cloud::dialogflow::v2::Message* StreamingAnalyzeContentResponse::mutable_message() {
  ::google::cloud::dialogflow::v2::Message* _msg = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.message)
  return _msg;
}
inline void StreamingAnalyzeContentResponse::set_allocated_message(::google::cloud::dialogflow::v2::Message* message) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.message_;
  }
  ...
  _impl_.message_ = message;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.message)
}

// repeated .google.cloud.dialogflow.v2.SuggestionResult human_agent_suggestion_results = 7;
inline int StreamingAnalyzeContentResponse::_internal_human_agent_suggestion_results_size() const {
  return _impl_.human_agent_suggestion_results_.size();
}
inline int StreamingAnalyzeContentResponse::human_agent_suggestion_results_size() const {
  return _internal_human_agent_suggestion_results_size();
}
inline void StreamingAnalyzeContentResponse::clear_human_agent_suggestion_results() {
  _impl_.human_agent_suggestion_results_.Clear();
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::mutable_human_agent_suggestion_results(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.human_agent_suggestion_results)
  return _impl_.human_agent_suggestion_results_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2::SuggestionResult >*
StreamingAnalyzeContentResponse::mutable_human_agent_suggestion_results() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.human_agent_suggestion_results)
  return &_impl_.human_agent_suggestion_results_;
}
inline const ::google::cloud::dialogflow::v2::SuggestionResult& StreamingAnalyzeContentResponse::_internal_human_agent_suggestion_results(int index) const {
  return _impl_.human_agent_suggestion_results_.Get(index);
}
inline const ::google::cloud::dialogflow::v2::SuggestionResult& StreamingAnalyzeContentResponse::human_agent_suggestion_results(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.human_agent_suggestion_results)
  return _internal_human_agent_suggestion_results(index);
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::_internal_add_human_agent_suggestion_results() {
  return _impl_.human_agent_suggestion_results_.Add();
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::add_human_agent_suggestion_results() {
  ::google::cloud::dialogflow::v2::SuggestionResult* _add = _internal_add_human_agent_suggestion_results();
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.human_agent_suggestion_results)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2::SuggestionResult >&
StreamingAnalyzeContentResponse::human_agent_suggestion_results() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.human_agent_suggestion_results)
  return _impl_.human_agent_suggestion_results_;
}

// repeated .google.cloud.dialogflow.v2.SuggestionResult end_user_suggestion_results = 8;
inline int StreamingAnalyzeContentResponse::_internal_end_user_suggestion_results_size() const {
  return _impl_.end_user_suggestion_results_.size();
}
inline int StreamingAnalyzeContentResponse::end_user_suggestion_results_size() const {
  return _internal_end_user_suggestion_results_size();
}
inline void StreamingAnalyzeContentResponse::clear_end_user_suggestion_results() {
  _impl_.end_user_suggestion_results_.Clear();
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::mutable_end_user_suggestion_results(int index) {
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.end_user_suggestion_results)
  return _impl_.end_user_suggestion_results_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2::SuggestionResult >*
StreamingAnalyzeContentResponse::mutable_end_user_suggestion_results() {
  // @@protoc_insertion_point(field_mutable_list:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.end_user_suggestion_results)
  return &_impl_.end_user_suggestion_results_;
}
inline const ::google::cloud::dialogflow::v2::SuggestionResult& StreamingAnalyzeContentResponse::_internal_end_user_suggestion_results(int index) const {
  return _impl_.end_user_suggestion_results_.Get(index);
}
inline const ::google::cloud::dialogflow::v2::SuggestionResult& StreamingAnalyzeContentResponse::end_user_suggestion_results(int index) const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.end_user_suggestion_results)
  return _internal_end_user_suggestion_results(index);
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::_internal_add_end_user_suggestion_results() {
  return _impl_.end_user_suggestion_results_.Add();
}
inline ::google::cloud::dialogflow::v2::SuggestionResult* StreamingAnalyzeContentResponse::add_end_user_suggestion_results() {
  ::google::cloud::dialogflow::v2::SuggestionResult* _add = _internal_add_end_user_suggestion_results();
  // @@protoc_insertion_point(field_add:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.end_user_suggestion_results)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::cloud::dialogflow::v2::SuggestionResult >&
StreamingAnalyzeContentResponse::end_user_suggestion_results() const {
  // @@protoc_insertion_point(field_list:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.end_user_suggestion_results)
  return _impl_.end_user_suggestion_results_;
}

// .google.cloud.dialogflow.v2.DtmfParameters dtmf_parameters = 10;
inline bool StreamingAnalyzeContentResponse::_internal_has_dtmf_parameters() const {
  return this != internal_default_instance() && _impl_.dtmf_parameters_ != nullptr;
}
inline bool StreamingAnalyzeContentResponse::has_dtmf_parameters() const {
  return _internal_has_dtmf_parameters();
}
inline void StreamingAnalyzeContentResponse::clear_dtmf_parameters() {
  if (GetArenaForAllocation() == nullptr && _impl_.dtmf_parameters_ != nullptr) {
    delete _impl_.dtmf_parameters_;
  }
  _impl_.dtmf_parameters_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::DtmfParameters& StreamingAnalyzeContentResponse::_internal_dtmf_parameters() const {
  const ::google::cloud::dialogflow::v2::DtmfParameters* p = _impl_.dtmf_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::DtmfParameters&>(
      ::google::cloud::dialogflow::v2::_DtmfParameters_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::DtmfParameters& StreamingAnalyzeContentResponse::dtmf_parameters() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.dtmf_parameters)
  return _internal_dtmf_parameters();
}
inline void StreamingAnalyzeContentResponse::unsafe_arena_set_allocated_dtmf_parameters(
    ::google::cloud::dialogflow::v2::DtmfParameters* dtmf_parameters) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.dtmf_parameters_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.dtmf_parameters)
}
inline ::google::cloud::dialogflow::v2::DtmfParameters* StreamingAnalyzeContentResponse::release_dtmf_parameters() {
...
inline ::google::cloud::dialogflow::v2::DtmfParameters* StreamingAnalyzeContentResponse::unsafe_arena_release_dtmf_parameters() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.dtmf_parameters)
  
  ::google::cloud::dialogflow::v2::DtmfParameters* temp = _impl_.dtmf_parameters_;
  _impl_.dtmf_parameters_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::DtmfParameters* StreamingAnalyzeContentResponse::_internal_mutable_dtmf_parameters() {
...
inline ::google::cloud::dialogflow::v2::DtmfParameters* StreamingAnalyzeContentResponse::mutable_dtmf_parameters() {
  ::google::cloud::dialogflow::v2::DtmfParameters* _msg = _internal_mutable_dtmf_parameters();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.dtmf_parameters)
  return _msg;
}
inline void StreamingAnalyzeContentResponse::set_allocated_dtmf_parameters(::google::cloud::dialogflow::v2::DtmfParameters* dtmf_parameters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.dtmf_parameters_;
  }
  ...
  _impl_.dtmf_parameters_ = dtmf_parameters;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.StreamingAnalyzeContentResponse.dtmf_parameters)
}
...
// string cx_current_page = 11;
inline void AutomatedAgentReply::clear_cx_current_page() {
  _impl_.cx_current_page_.ClearToEmpty();
}
inline const std::string& AutomatedAgentReply::cx_current_page() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.AutomatedAgentReply.cx_current_page)
  return _internal_cx_current_page();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AutomatedAgentReply::set_cx_current_page(ArgT0&& arg0, ArgT... args) {
 
 _impl_.cx_current_page_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.AutomatedAgentReply.cx_current_page)
}
inline std::string* AutomatedAgentReply::mutable_cx_current_page() {
  std::string* _s = _internal_mutable_cx_current_page();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.AutomatedAgentReply.cx_current_page)
  return _s;
}
inline const std::string& AutomatedAgentReply::_internal_cx_current_page() const {
  return _impl_.cx_current_page_.Get();
}
inline void AutomatedAgentReply::_internal_set_cx_current_page(const std::string& value) {
  
  _impl_.cx_current_page_.Set(value, GetArenaForAllocation());
}
inline std::string* AutomatedAgentReply::_internal_mutable_cx_current_page() {
  
  return _impl_.cx_current_page_.Mutable(GetArenaForAllocation());
}
inline std::string* AutomatedAgentReply::release_cx_current_page() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.AutomatedAgentReply.cx_current_page)
  return _impl_.cx_current_page_.Release();
}
inline void AutomatedAgentReply::set_allocated_cx_current_page(std::string* cx_current_page) {
  if (cx_current_page != nullptr) {
    
  } else {
    
  }
  _impl_.cx_current_page_.SetAllocated(cx_current_page, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.cx_current_page_.IsDefault()) {
    _impl_.cx_current_page_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.AutomatedAgentReply.cx_current_page)
}
...
// string language_code = 1 [(.google.api.field_behavior) = REQUIRED];
inline void InputTextConfig::clear_language_code() {
  _impl_.language_code_.ClearToEmpty();
}
inline const std::string& InputTextConfig::language_code() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.InputTextConfig.language_code)
  return _internal_language_code();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void InputTextConfig::set_language_code(ArgT0&& arg0, ArgT... args) {
 
 _impl_.language_code_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.InputTextConfig.language_code)
}
inline std::string* InputTextConfig::mutable_language_code() {
  std::string* _s = _internal_mutable_language_code();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.InputTextConfig.language_code)
  return _s;
}
inline const std::string& InputTextConfig::_internal_language_code() const {
  return _impl_.language_code_.Get();
}
inline void InputTextConfig::_internal_set_language_code(const std::string& value) {
  
  _impl_.language_code_.Set(value, GetArenaForAllocation());
}
inline std::string* InputTextConfig::_internal_mutable_language_code() {
  
  return _impl_.language_code_.Mutable(GetArenaForAllocation());
}
inline std::string* InputTextConfig::release_language_code() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.InputTextConfig.language_code)
  return _impl_.language_code_.Release();
}
inline void InputTextConfig::set_allocated_language_code(std::string* language_code) {
  if (language_code != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.InputTextConfig.language_code)
}
