...
inline void Environment::set_allocated_agent_version(std::string* agent_version) {
  ...
  agent_version_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), agent_version,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (agent_version_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    agent_version_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline void Environment::clear_text_to_speech_settings() {
  if (GetArenaForAllocation() == nullptr && text_to_speech_settings_ != nullptr) {
...
inline void Environment::set_allocated_text_to_speech_settings(::google::cloud::dialogflow::v2::TextToSpeechSettings* text_to_speech_settings) {
  ...
  if (text_to_speech_settings) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::dialogflow::v2::TextToSpeechSettings>::GetOwningArena(text_to_speech_settings);
    if (message_arena != submessage_arena) {
...
inline void CreateEnvironmentRequest::set_allocated_environment(::google::cloud::dialogflow::v2::Environment* environment) {
  ...
  if (environment) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::dialogflow::v2::Environment>::GetOwningArena(environment);
    if (message_arena != submessage_arena) {
...
inline void CreateEnvironmentRequest::set_allocated_environment_id(std::string* environment_id) {
  ...
  environment_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), environment_id,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (environment_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    environment_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
