...
inline void CreateKnowledgeBaseRequest::clear_knowledge_base() {
  if (GetArenaForAllocation() == nullptr && knowledge_base_ != nullptr) {
...
inline void CreateKnowledgeBaseRequest::set_allocated_knowledge_base(::google::cloud::dialogflow::v2::KnowledgeBase* knowledge_base) {
  ...
  if (knowledge_base) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::dialogflow::v2::KnowledgeBase>::GetOwningArena(knowledge_base);
