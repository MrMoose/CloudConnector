...
class ConversationProfile final :
 ...
 public:
  ...
  private:
  bool _internal_has_tts_config() const;
  public:
  void clear_tts_config();
  const ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig& tts_config() const;
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* release_tts_config();
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* mutable_tts_config();
  void set_allocated_tts_config(::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* tts_config);
  private:
  const ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig& _internal_tts_config() const;
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* _internal_mutable_tts_config();
  public:
  void unsafe_arena_set_allocated_tts_config(
      ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* tts_config);
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* unsafe_arena_release_tts_config();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* tts_config_;
...
// .google.cloud.dialogflow.v2.SynthesizeSpeechConfig tts_config = 18;
inline bool ConversationProfile::_internal_has_tts_config() const {
  return this != internal_default_instance() && _impl_.tts_config_ != nullptr;
}
inline bool ConversationProfile::has_tts_config() const {
  return _internal_has_tts_config();
}
inline const ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig& ConversationProfile::_internal_tts_config() const {
  const ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* p = _impl_.tts_config_;
...
inline const ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig& ConversationProfile::tts_config() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.ConversationProfile.tts_config)
  return _internal_tts_config();
}
inline void ConversationProfile::unsafe_arena_set_allocated_tts_config(
    ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* tts_config) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.tts_config_);
  }
  _impl_.tts_config_ = tts_config;
  if (tts_config) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.ConversationProfile.tts_config)
}
inline ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* ConversationProfile::release_tts_config() {
  
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* temp = _impl_.tts_config_;
...
inline ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* ConversationProfile::unsafe_arena_release_tts_config() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.ConversationProfile.tts_config)
  
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* temp = _impl_.tts_config_;
  _impl_.tts_config_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* ConversationProfile::_internal_mutable_tts_config() {
  ...
  if (_impl_.tts_config_ == nullptr) {
    ...
    _impl_.tts_config_ = p;
  }
  return _impl_.tts_config_;
}
inline ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* ConversationProfile::mutable_tts_config() {
  ::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* _msg = _internal_mutable_tts_config();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.ConversationProfile.tts_config)
  return _msg;
}
inline void ConversationProfile::set_allocated_tts_config(::google::cloud::dialogflow::v2::SynthesizeSpeechConfig* tts_config) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.tts_config_);
  }
  if (tts_config) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(tts_config));
    if (message_arena != submessage_arena) {
      tts_config = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, tts_config, submessage_arena);
    }
  ...
  _impl_.tts_config_ = tts_config;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.ConversationProfile.tts_config)
}
