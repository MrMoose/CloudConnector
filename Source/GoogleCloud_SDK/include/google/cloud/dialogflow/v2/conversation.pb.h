...
struct SuggestConversationSummaryRequestDefaultTypeInternal;
extern SuggestConversationSummaryRequestDefaultTypeInternal _SuggestConversationSummaryRequest_default_instance_;
class SuggestConversationSummaryResponse;
struct SuggestConversationSummaryResponseDefaultTypeInternal;
extern SuggestConversationSummaryResponseDefaultTypeInternal _SuggestConversationSummaryResponse_default_instance_;
class SuggestConversationSummaryResponse_Summary;
struct SuggestConversationSummaryResponse_SummaryDefaultTypeInternal;
extern SuggestConversationSummaryResponse_SummaryDefaultTypeInternal _SuggestConversationSummaryResponse_Summary_default_instance_;
class SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse;
struct SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUseDefaultTypeInternal;
extern SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUseDefaultTypeInternal _SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse_default_instance_;
}  // namespace v2
}  // namespace dialogflow
}  // namespace cloud
}  // namespace google
...
template<> ::google::cloud::dialogflow::v2::SuggestConversationSummaryRequest* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::SuggestConversationSummaryRequest>(Arena*);
template<> ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse>(Arena*);
template<> ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary>(Arena*);
template<> ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse* Arena::CreateMaybeMessage<::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace google {
namespace cloud {
namespace dialogflow {
...
class SuggestConversationSummaryRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest) */ {
 public:
  inline SuggestConversationSummaryRequest() : SuggestConversationSummaryRequest(nullptr) {}
  ~SuggestConversationSummaryRequest() override;
  explicit PROTOBUF_CONSTEXPR SuggestConversationSummaryRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SuggestConversationSummaryRequest(const SuggestConversationSummaryRequest& from);
  SuggestConversationSummaryRequest(SuggestConversationSummaryRequest&& from) noexcept
    : SuggestConversationSummaryRequest() {
    *this = ::std::move(from);
  }

  inline SuggestConversationSummaryRequest& operator=(const SuggestConversationSummaryRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline SuggestConversationSummaryRequest& operator=(SuggestConversationSummaryRequest&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SuggestConversationSummaryRequest& default_instance() {
    return *internal_default_instance();
  }
  static inline const SuggestConversationSummaryRequest* internal_default_instance() {
    return reinterpret_cast<const SuggestConversationSummaryRequest*>(
               &_SuggestConversationSummaryRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(SuggestConversationSummaryRequest& a, SuggestConversationSummaryRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(SuggestConversationSummaryRequest* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SuggestConversationSummaryRequest* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SuggestConversationSummaryRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SuggestConversationSummaryRequest>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SuggestConversationSummaryRequest& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SuggestConversationSummaryRequest& from) {
    SuggestConversationSummaryRequest::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SuggestConversationSummaryRequest* other);
  ...
  protected:
  explicit SuggestConversationSummaryRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    ...
    kLatestMessageFieldNumber = 3,
    kAssistQueryParamsFieldNumber = 5,
    kContextSizeFieldNumber = 4,
  };
...
class SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse, 
    std::string, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse, 
    std::string, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> SuperType;
  SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse();
  explicit PROTOBUF_CONSTEXPR SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  explicit SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse& other);
  static const SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse*>(&_SuggestConversationSummaryResponse_Summary_TextSectionsEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.TextSectionsEntry.key");
 }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.TextSectionsEntry.value");
 }
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadata() const final;
  friend struct ::TableStruct_google_2fcloud_2fdialogflow_2fv2_2fconversation_2eproto;
...
class SuggestConversationSummaryResponse_Summary final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary) */ {
 public:
  inline SuggestConversationSummaryResponse_Summary() : SuggestConversationSummaryResponse_Summary(nullptr) {}
  ~SuggestConversationSummaryResponse_Summary() override;
  explicit PROTOBUF_CONSTEXPR SuggestConversationSummaryResponse_Summary(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SuggestConversationSummaryResponse_Summary(const SuggestConversationSummaryResponse_Summary& from);
  SuggestConversationSummaryResponse_Summary(SuggestConversationSummaryResponse_Summary&& from) noexcept
    : SuggestConversationSummaryResponse_Summary() {
    *this = ::std::move(from);
  }

  inline SuggestConversationSummaryResponse_Summary& operator=(const SuggestConversationSummaryResponse_Summary& from) {
    CopyFrom(from);
    return *this;
  }
  inline SuggestConversationSummaryResponse_Summary& operator=(SuggestConversationSummaryResponse_Summary&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SuggestConversationSummaryResponse_Summary& default_instance() {
    return *internal_default_instance();
  }
  static inline const SuggestConversationSummaryResponse_Summary* internal_default_instance() {
    return reinterpret_cast<const SuggestConversationSummaryResponse_Summary*>(
               &_SuggestConversationSummaryResponse_Summary_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(SuggestConversationSummaryResponse_Summary& a, SuggestConversationSummaryResponse_Summary& b) {
    a.Swap(&b);
  }
  inline void Swap(SuggestConversationSummaryResponse_Summary* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SuggestConversationSummaryResponse_Summary* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SuggestConversationSummaryResponse_Summary* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SuggestConversationSummaryResponse_Summary>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SuggestConversationSummaryResponse_Summary& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SuggestConversationSummaryResponse_Summary& from) {
    SuggestConversationSummaryResponse_Summary::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SuggestConversationSummaryResponse_Summary* other);
  ...
  protected:
  explicit SuggestConversationSummaryResponse_Summary(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  ...
  enum : int {
    kTextSectionsFieldNumber = 4,
    kTextFieldNumber = 1,
    kAnswerRecordFieldNumber = 3,
  };
  // map<string, string> text_sections = 4;
  int text_sections_size() const;
  private:
  int _internal_text_sections_size() const;
  public:
  void clear_text_sections();
  private:
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
      _internal_text_sections() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
      _internal_mutable_text_sections();
  public:
  const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
      text_sections() const;
  ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
      mutable_text_sections();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::MapField<
        ...
        std::string, std::string,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING> text_sections_;
...
class SuggestConversationSummaryResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse) */ {
 public:
  inline SuggestConversationSummaryResponse() : SuggestConversationSummaryResponse(nullptr) {}
  ~SuggestConversationSummaryResponse() override;
  explicit PROTOBUF_CONSTEXPR SuggestConversationSummaryResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  SuggestConversationSummaryResponse(const SuggestConversationSummaryResponse& from);
  SuggestConversationSummaryResponse(SuggestConversationSummaryResponse&& from) noexcept
    : SuggestConversationSummaryResponse() {
    *this = ::std::move(from);
  }

  inline SuggestConversationSummaryResponse& operator=(const SuggestConversationSummaryResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline SuggestConversationSummaryResponse& operator=(SuggestConversationSummaryResponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const SuggestConversationSummaryResponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const SuggestConversationSummaryResponse* internal_default_instance() {
    return reinterpret_cast<const SuggestConversationSummaryResponse*>(
               &_SuggestConversationSummaryResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    12;

  friend void swap(SuggestConversationSummaryResponse& a, SuggestConversationSummaryResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(SuggestConversationSummaryResponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SuggestConversationSummaryResponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SuggestConversationSummaryResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<SuggestConversationSummaryResponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const SuggestConversationSummaryResponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const SuggestConversationSummaryResponse& from) {
    SuggestConversationSummaryResponse::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(SuggestConversationSummaryResponse* other);
  ...
  protected:
  explicit SuggestConversationSummaryResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef SuggestConversationSummaryResponse_Summary Summary;
  ...
  public:
  void clear_summary();
  const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary& summary() const;
  PROTOBUF_NODISCARD ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* release_summary();
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* mutable_summary();
  void set_allocated_summary(::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* summary);
  private:
  const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary& _internal_summary() const;
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* _internal_mutable_summary();
  public:
  void unsafe_arena_set_allocated_summary(
      ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* summary);
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* unsafe_arena_release_summary();
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr latest_message_;
    ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* summary_;
    int32_t context_size_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
// string conversation = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = {
inline void SuggestConversationSummaryRequest::clear_conversation() {
  _impl_.conversation_.ClearToEmpty();
}
inline const std::string& SuggestConversationSummaryRequest::conversation() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.conversation)
  return _internal_conversation();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SuggestConversationSummaryRequest::set_conversation(ArgT0&& arg0, ArgT... args) {
 
 _impl_.conversation_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.conversation)
}
inline std::string* SuggestConversationSummaryRequest::mutable_conversation() {
  std::string* _s = _internal_mutable_conversation();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.conversation)
  return _s;
}
inline const std::string& SuggestConversationSummaryRequest::_internal_conversation() const {
  return _impl_.conversation_.Get();
}
inline void SuggestConversationSummaryRequest::_internal_set_conversation(const std::string& value) {
  
  _impl_.conversation_.Set(value, GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryRequest::_internal_mutable_conversation() {
  
  return _impl_.conversation_.Mutable(GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryRequest::release_conversation() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.conversation)
  return _impl_.conversation_.Release();
}
inline void SuggestConversationSummaryRequest::set_allocated_conversation(std::string* conversation) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.conversation)
}

// string latest_message = 3 [(.google.api.resource_reference) = {
inline void SuggestConversationSummaryRequest::clear_latest_message() {
  _impl_.latest_message_.ClearToEmpty();
}
inline const std::string& SuggestConversationSummaryRequest::latest_message() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.latest_message)
  return _internal_latest_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SuggestConversationSummaryRequest::set_latest_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.latest_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.latest_message)
}
inline std::string* SuggestConversationSummaryRequest::mutable_latest_message() {
  std::string* _s = _internal_mutable_latest_message();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.latest_message)
  return _s;
}
inline const std::string& SuggestConversationSummaryRequest::_internal_latest_message() const {
  return _impl_.latest_message_.Get();
}
inline void SuggestConversationSummaryRequest::_internal_set_latest_message(const std::string& value) {
  
  _impl_.latest_message_.Set(value, GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryRequest::_internal_mutable_latest_message() {
  
  return _impl_.latest_message_.Mutable(GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryRequest::release_latest_message() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.latest_message)
  return _impl_.latest_message_.Release();
}
inline void SuggestConversationSummaryRequest::set_allocated_latest_message(std::string* latest_message) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.latest_message)
}

// int32 context_size = 4;
inline void SuggestConversationSummaryRequest::clear_context_size() {
  _impl_.context_size_ = 0;
}
inline int32_t SuggestConversationSummaryRequest::_internal_context_size() const {
  return _impl_.context_size_;
}
inline int32_t SuggestConversationSummaryRequest::context_size() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.context_size)
  return _internal_context_size();
}
inline void SuggestConversationSummaryRequest::_internal_set_context_size(int32_t value) {
  
  _impl_.context_size_ = value;
}
inline void SuggestConversationSummaryRequest::set_context_size(int32_t value) {
  _internal_set_context_size(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.context_size)
}

// .google.cloud.dialogflow.v2.AssistQueryParameters assist_query_params = 5;
inline bool SuggestConversationSummaryRequest::_internal_has_assist_query_params() const {
  return this != internal_default_instance() && _impl_.assist_query_params_ != nullptr;
}
inline bool SuggestConversationSummaryRequest::has_assist_query_params() const {
  return _internal_has_assist_query_params();
}
inline const ::google::cloud::dialogflow::v2::AssistQueryParameters& SuggestConversationSummaryRequest::_internal_assist_query_params() const {
...
inline const ::google::cloud::dialogflow::v2::AssistQueryParameters& SuggestConversationSummaryRequest::assist_query_params() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.assist_query_params)
  return _internal_assist_query_params();
}
inline void SuggestConversationSummaryRequest::unsafe_arena_set_allocated_assist_query_params(
    ::google::cloud::dialogflow::v2::AssistQueryParameters* assist_query_params) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.assist_query_params)
}
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* SuggestConversationSummaryRequest::release_assist_query_params() {
...
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* SuggestConversationSummaryRequest::unsafe_arena_release_assist_query_params() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.assist_query_params)
  
  ::google::cloud::dialogflow::v2::AssistQueryParameters* temp = _impl_.assist_query_params_;
  _impl_.assist_query_params_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* SuggestConversationSummaryRequest::_internal_mutable_assist_query_params() {
...
inline ::google::cloud::dialogflow::v2::AssistQueryParameters* SuggestConversationSummaryRequest::mutable_assist_query_params() {
  ::google::cloud::dialogflow::v2::AssistQueryParameters* _msg = _internal_mutable_assist_query_params();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.assist_query_params)
  return _msg;
}
inline void SuggestConversationSummaryRequest::set_allocated_assist_query_params(::google::cloud::dialogflow::v2::AssistQueryParameters* assist_query_params) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.assist_query_params_);
  }
  if (assist_query_params) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(assist_query_params));
    if (message_arena != submessage_arena) {
  ...
  _impl_.assist_query_params_ = assist_query_params;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryRequest.assist_query_params)
}
...
// string text = 1;
inline void SuggestConversationSummaryResponse_Summary::clear_text() {
  _impl_.text_.ClearToEmpty();
}
inline const std::string& SuggestConversationSummaryResponse_Summary::text() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text)
  return _internal_text();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SuggestConversationSummaryResponse_Summary::set_text(ArgT0&& arg0, ArgT... args) {
 
 _impl_.text_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text)
}
inline std::string* SuggestConversationSummaryResponse_Summary::mutable_text() {
  std::string* _s = _internal_mutable_text();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text)
  return _s;
}
inline const std::string& SuggestConversationSummaryResponse_Summary::_internal_text() const {
  return _impl_.text_.Get();
}
inline void SuggestConversationSummaryResponse_Summary::_internal_set_text(const std::string& value) {
  
  _impl_.text_.Set(value, GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse_Summary::_internal_mutable_text() {
  
  return _impl_.text_.Mutable(GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse_Summary::release_text() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text)
  return _impl_.text_.Release();
}
inline void SuggestConversationSummaryResponse_Summary::set_allocated_text(std::string* text) {
  if (text != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text)
}

// map<string, string> text_sections = 4;
inline int SuggestConversationSummaryResponse_Summary::_internal_text_sections_size() const {
  return _impl_.text_sections_.size();
}
inline int SuggestConversationSummaryResponse_Summary::text_sections_size() const {
  return _internal_text_sections_size();
}
inline void SuggestConversationSummaryResponse_Summary::clear_text_sections() {
  _impl_.text_sections_.Clear();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
SuggestConversationSummaryResponse_Summary::_internal_text_sections() const {
  return _impl_.text_sections_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >&
SuggestConversationSummaryResponse_Summary::text_sections() const {
  // @@protoc_insertion_point(field_map:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text_sections)
  return _internal_text_sections();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
SuggestConversationSummaryResponse_Summary::_internal_mutable_text_sections() {
  return _impl_.text_sections_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< std::string, std::string >*
SuggestConversationSummaryResponse_Summary::mutable_text_sections() {
  // @@protoc_insertion_point(field_mutable_map:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.text_sections)
  return _internal_mutable_text_sections();
}

// string answer_record = 3 [(.google.api.resource_reference) = {
inline void SuggestConversationSummaryResponse_Summary::clear_answer_record() {
  _impl_.answer_record_.ClearToEmpty();
}
inline const std::string& SuggestConversationSummaryResponse_Summary::answer_record() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.answer_record)
  return _internal_answer_record();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SuggestConversationSummaryResponse_Summary::set_answer_record(ArgT0&& arg0, ArgT... args) {
 
 _impl_.answer_record_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.answer_record)
}
inline std::string* SuggestConversationSummaryResponse_Summary::mutable_answer_record() {
  std::string* _s = _internal_mutable_answer_record();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.answer_record)
  return _s;
}
inline const std::string& SuggestConversationSummaryResponse_Summary::_internal_answer_record() const {
  return _impl_.answer_record_.Get();
}
inline void SuggestConversationSummaryResponse_Summary::_internal_set_answer_record(const std::string& value) {
  
  _impl_.answer_record_.Set(value, GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse_Summary::_internal_mutable_answer_record() {
  
  return _impl_.answer_record_.Mutable(GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse_Summary::release_answer_record() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.answer_record)
  return _impl_.answer_record_.Release();
}
inline void SuggestConversationSummaryResponse_Summary::set_allocated_answer_record(std::string* answer_record) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary.answer_record)
}
...
// .google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.Summary summary = 1;
inline bool SuggestConversationSummaryResponse::_internal_has_summary() const {
  return this != internal_default_instance() && _impl_.summary_ != nullptr;
}
inline bool SuggestConversationSummaryResponse::has_summary() const {
  return _internal_has_summary();
}
inline void SuggestConversationSummaryResponse::clear_summary() {
  if (GetArenaForAllocation() == nullptr && _impl_.summary_ != nullptr) {
    delete _impl_.summary_;
  }
  _impl_.summary_ = nullptr;
}
inline const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary& SuggestConversationSummaryResponse::_internal_summary() const {
  const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* p = _impl_.summary_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary&>(
      ::google::cloud::dialogflow::v2::_SuggestConversationSummaryResponse_Summary_default_instance_);
}
inline const ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary& SuggestConversationSummaryResponse::summary() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.summary)
  return _internal_summary();
}
inline void SuggestConversationSummaryResponse::unsafe_arena_set_allocated_summary(
    ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* summary) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.summary)
}
inline ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* SuggestConversationSummaryResponse::release_summary() {
  
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* temp = _impl_.summary_;
  _impl_.summary_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* SuggestConversationSummaryResponse::unsafe_arena_release_summary() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.summary)
  
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* temp = _impl_.summary_;
  _impl_.summary_ = nullptr;
  return temp;
}
inline ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* SuggestConversationSummaryResponse::_internal_mutable_summary() {
  
  if (_impl_.summary_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary>(GetArenaForAllocation());
    _impl_.summary_ = p;
  }
  return _impl_.summary_;
}
inline ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* SuggestConversationSummaryResponse::mutable_summary() {
  ::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* _msg = _internal_mutable_summary();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.summary)
  return _msg;
}
inline void SuggestConversationSummaryResponse::set_allocated_summary(::google::cloud::dialogflow::v2::SuggestConversationSummaryResponse_Summary* summary) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.summary_;
  }
  ...
  _impl_.summary_ = summary;
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.summary)
}

// string latest_message = 2 [(.google.api.resource_reference) = {
inline void SuggestConversationSummaryResponse::clear_latest_message() {
  _impl_.latest_message_.ClearToEmpty();
}
inline const std::string& SuggestConversationSummaryResponse::latest_message() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.latest_message)
  return _internal_latest_message();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SuggestConversationSummaryResponse::set_latest_message(ArgT0&& arg0, ArgT... args) {
 
 _impl_.latest_message_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.latest_message)
}
inline std::string* SuggestConversationSummaryResponse::mutable_latest_message() {
  std::string* _s = _internal_mutable_latest_message();
  // @@protoc_insertion_point(field_mutable:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.latest_message)
  return _s;
}
inline const std::string& SuggestConversationSummaryResponse::_internal_latest_message() const {
  return _impl_.latest_message_.Get();
}
inline void SuggestConversationSummaryResponse::_internal_set_latest_message(const std::string& value) {
  
  _impl_.latest_message_.Set(value, GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse::_internal_mutable_latest_message() {
  
  return _impl_.latest_message_.Mutable(GetArenaForAllocation());
}
inline std::string* SuggestConversationSummaryResponse::release_latest_message() {
  // @@protoc_insertion_point(field_release:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.latest_message)
  return _impl_.latest_message_.Release();
}
inline void SuggestConversationSummaryResponse::set_allocated_latest_message(std::string* latest_message) {
  if (latest_message != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.latest_message)
}

// int32 context_size = 3;
inline void SuggestConversationSummaryResponse::clear_context_size() {
  _impl_.context_size_ = 0;
}
inline int32_t SuggestConversationSummaryResponse::_internal_context_size() const {
  return _impl_.context_size_;
}
inline int32_t SuggestConversationSummaryResponse::context_size() const {
  // @@protoc_insertion_point(field_get:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.context_size)
  return _internal_context_size();
}
inline void SuggestConversationSummaryResponse::_internal_set_context_size(int32_t value) {
  
  _impl_.context_size_ = value;
}
inline void SuggestConversationSummaryResponse::set_context_size(int32_t value) {
  _internal_set_context_size(value);
  // @@protoc_insertion_point(field_set:google.cloud.dialogflow.v2.SuggestConversationSummaryResponse.context_size)
}
