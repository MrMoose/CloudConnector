...
class CloudSpannerProperties final :
 ...
 public:
  ...
  enum : int {
    ...
    kDatabaseRoleFieldNumber = 4,
    kUseParallelismFieldNumber = 2,
    kUseServerlessAnalyticsFieldNumber = 3,
  };
  // string database = 1;
  void clear_database();
  const std::string& database() const;
  ...
  void clear_database_role();
  const std::string& database_role() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_database_role(ArgT0&& arg0, ArgT... args);
  std::string* mutable_database_role();
  PROTOBUF_NODISCARD std::string* release_database_role();
  void set_allocated_database_role(std::string* database_role);
  private:
  const std::string& _internal_database_role() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_database_role(const std::string& value);
  std::string* _internal_mutable_database_role();
  public:
  ...
  void clear_use_serverless_analytics();
  bool use_serverless_analytics() const;
  void set_use_serverless_analytics(bool value);
  private:
  bool _internal_use_serverless_analytics() const;
  void _internal_set_use_serverless_analytics(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr database_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr database_role_;
    bool use_parallelism_;
    bool use_serverless_analytics_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_google_2fcloud_2fbigquery_2fconnection_2fv1_2fconnection_2eproto;
...
// bool use_serverless_analytics = 3;
inline void CloudSpannerProperties::clear_use_serverless_analytics() {
  _impl_.use_serverless_analytics_ = false;
}
inline bool CloudSpannerProperties::_internal_use_serverless_analytics() const {
  return _impl_.use_serverless_analytics_;
}
inline bool CloudSpannerProperties::use_serverless_analytics() const {
  // @@protoc_insertion_point(field_get:google.cloud.bigquery.connection.v1.CloudSpannerProperties.use_serverless_analytics)
  return _internal_use_serverless_analytics();
}
inline void CloudSpannerProperties::_internal_set_use_serverless_analytics(bool value) {
  
  _impl_.use_serverless_analytics_ = value;
}
inline void CloudSpannerProperties::set_use_serverless_analytics(bool value) {
  _internal_set_use_serverless_analytics(value);
  // @@protoc_insertion_point(field_set:google.cloud.bigquery.connection.v1.CloudSpannerProperties.use_serverless_analytics)
}

// string database_role = 4 [(.google.api.field_behavior) = OPTIONAL];
inline void CloudSpannerProperties::clear_database_role() {
  _impl_.database_role_.ClearToEmpty();
}
inline const std::string& CloudSpannerProperties::database_role() const {
  // @@protoc_insertion_point(field_get:google.cloud.bigquery.connection.v1.CloudSpannerProperties.database_role)
  return _internal_database_role();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CloudSpannerProperties::set_database_role(ArgT0&& arg0, ArgT... args) {
 
 _impl_.database_role_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.cloud.bigquery.connection.v1.CloudSpannerProperties.database_role)
}
inline std::string* CloudSpannerProperties::mutable_database_role() {
  std::string* _s = _internal_mutable_database_role();
  // @@protoc_insertion_point(field_mutable:google.cloud.bigquery.connection.v1.CloudSpannerProperties.database_role)
  return _s;
}
inline const std::string& CloudSpannerProperties::_internal_database_role() const {
  return _impl_.database_role_.Get();
}
inline void CloudSpannerProperties::_internal_set_database_role(const std::string& value) {
  
  _impl_.database_role_.Set(value, GetArenaForAllocation());
}
inline std::string* CloudSpannerProperties::_internal_mutable_database_role() {
  
  return _impl_.database_role_.Mutable(GetArenaForAllocation());
}
inline std::string* CloudSpannerProperties::release_database_role() {
  // @@protoc_insertion_point(field_release:google.cloud.bigquery.connection.v1.CloudSpannerProperties.database_role)
  return _impl_.database_role_.Release();
}
inline void CloudSpannerProperties::set_allocated_database_role(std::string* database_role) {
  if (database_role != nullptr) {
    
  } else {
    
  }
  _impl_.database_role_.SetAllocated(database_role, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.database_role_.IsDefault()) {
    _impl_.database_role_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.cloud.bigquery.connection.v1.CloudSpannerProperties.database_role)
}
