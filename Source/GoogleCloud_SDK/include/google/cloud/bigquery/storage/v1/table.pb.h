...
class TableFieldSchema final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_default_value_expression(ArgT0&& arg0, ArgT... args);
  std::string* mutable_default_value_expression();
  PROTOBUF_NODISCARD std::string* release_default_value_expression();
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_default_value_expression(const std::string& value);
...
inline void TableFieldSchema::clear_default_value_expression() {
  _impl_.default_value_expression_.ClearToEmpty();
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TableFieldSchema::set_default_value_expression(ArgT0&& arg0, ArgT... args) {
 
 _impl_.default_value_expression_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TableFieldSchema::mutable_default_value_expression() {
  std::string* _s = _internal_mutable_default_value_expression();
...
inline const std::string& TableFieldSchema::_internal_default_value_expression() const {
  return _impl_.default_value_expression_.Get();
}
inline void TableFieldSchema::_internal_set_default_value_expression(const std::string& value) {
  
  _impl_.default_value_expression_.Set(value, GetArenaForAllocation());
}
inline std::string* TableFieldSchema::_internal_mutable_default_value_expression() {
  
  return _impl_.default_value_expression_.Mutable(GetArenaForAllocation());
}
inline std::string* TableFieldSchema::release_default_value_expression() {
  ...
  return _impl_.default_value_expression_.Release();
}
inline void TableFieldSchema::set_allocated_default_value_expression(std::string* default_value_expression) {
  ...
  _impl_.default_value_expression_.SetAllocated(default_value_expression, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.default_value_expression_.IsDefault()) {
    _impl_.default_value_expression_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
