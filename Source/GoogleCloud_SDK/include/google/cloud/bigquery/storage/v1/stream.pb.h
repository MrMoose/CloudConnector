...
class ReadSession_TableModifiers final :
 ...
 public:
  ...
  explicit constexpr ReadSession_TableModifiers(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReadSession_TableReadOptions final :
 ...
 public:
  ...
  explicit constexpr ReadSession_TableReadOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReadSession final :
 ...
 public:
  ...
  explicit constexpr ReadSession(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ReadStream final :
 ...
 public:
  ...
  ~ReadStream() override;
  explicit constexpr ReadStream(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void ReadSession_TableReadOptions::set_row_restriction(ArgT0&& arg0, ArgT... args) {
 ...
 row_restriction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ReadSession_TableReadOptions::_internal_set_row_restriction(const std::string& value) {
  ...
  row_restriction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ReadSession_TableReadOptions::_internal_mutable_row_restriction() {
  
  return row_restriction_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ReadSession_TableReadOptions::release_row_restriction() {
  ...
  return row_restriction_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void ReadSession_TableReadOptions::set_allocated_row_restriction(std::string* row_restriction) {
  ...
  if (row_restriction_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    row_restriction_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
inline ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions* ReadSession_TableReadOptions::_internal_mutable_arrow_serialization_options() {
  if (!_internal_has_arrow_serialization_options()) {
    clear_output_format_serialization_options();
    set_has_arrow_serialization_options();
    output_format_serialization_options_.arrow_serialization_options_ = CreateMaybeMessage< ::google::cloud::bigquery::storage::v1::ArrowSerializationOptions >(GetArenaForAllocation());
  }
...
inline void ReadSession::clear_table_modifiers() {
  if (GetArenaForAllocation() == nullptr && table_modifiers_ != nullptr) {
...
inline void ReadSession::set_allocated_table_modifiers(::google::cloud::bigquery::storage::v1::ReadSession_TableModifiers* table_modifiers) {
  ...
  if (table_modifiers) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::bigquery::storage::v1::ReadSession_TableModifiers>::GetOwningArena(table_modifiers);
    if (message_arena != submessage_arena) {
...
inline void ReadSession::clear_read_options() {
  if (GetArenaForAllocation() == nullptr && read_options_ != nullptr) {
...
inline void ReadSession::set_allocated_read_options(::google::cloud::bigquery::storage::v1::ReadSession_TableReadOptions* read_options) {
  ...
  if (read_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::cloud::bigquery::storage::v1::ReadSession_TableReadOptions>::GetOwningArena(read_options);
    if (message_arena != submessage_arena) {
...
inline void ReadSession::clear_estimated_total_bytes_scanned() {
  estimated_total_bytes_scanned_ = int64_t{0};
}
