...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2fstream_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
namespace bigquery {
namespace storage {
...
inline void ReadSession_TableReadOptions::_internal_set_row_restriction(const std::string& value) {
  ...
  row_restriction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ReadSession_TableReadOptions::set_row_restriction(const char* value) {
  ...
  row_restriction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:google.cloud.bigquery.storage.v1.ReadSession.TableReadOptions.row_restriction)
}
inline void ReadSession_TableReadOptions::set_row_restriction(const char* value,
    size_t size) {
  
  row_restriction_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* ReadSession_TableReadOptions::_internal_mutable_row_restriction() {
  ...
  return row_restriction_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
