...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_metadata_getter(int index);
namespace google {
namespace cloud {
namespace bigquery {
namespace storage {
...
class AvroSchema PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fcloud_2fbigquery_2fstorage_2fv1_2favro_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void AvroRows::_internal_set_serialized_binary_rows(const std::string& value) {
  ...
  serialized_binary_rows_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void AvroRows::set_serialized_binary_rows(const char* value) {
  ...
  serialized_binary_rows_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void AvroRows::set_serialized_binary_rows(const void* value,
  ...
  serialized_binary_rows_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* AvroRows::_internal_mutable_serialized_binary_rows() {
  ...
  return serialized_binary_rows_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
