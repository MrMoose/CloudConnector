...
class ListDatabaseOperationsRequestDefaultTypeInternal;
...
class ListDatabaseOperationsResponseDefaultTypeInternal;
...
class OptimizeRestoredDatabaseMetadataDefaultTypeInternal;
...
class RestoreDatabaseEncryptionConfigDefaultTypeInternal;
