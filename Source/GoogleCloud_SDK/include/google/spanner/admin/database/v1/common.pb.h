...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fspanner_2fadmin_2fdatabase_2fv1_2fcommon_2eproto_metadata_getter(int index);
namespace google {
namespace spanner {
namespace admin {
namespace database {
...
class OperationProgress PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fspanner_2fadmin_2fdatabase_2fv1_2fcommon_2eproto_metadata_getter(kIndexInFileMessages);
  }
