...
inline void Type::clear_array_element_type() {
  if (GetArenaForAllocation() == nullptr && array_element_type_ != nullptr) {
...
inline void Type::set_allocated_array_element_type(::google::spanner::v1::Type* array_element_type) {
  ...
  if (array_element_type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::spanner::v1::Type>::GetOwningArena(array_element_type);
...
inline void Type::clear_struct_type() {
  if (GetArenaForAllocation() == nullptr && struct_type_ != nullptr) {
    delete struct_type_;
  }
...
inline void Type::set_allocated_struct_type(::google::spanner::v1::StructType* struct_type) {
  ...
  if (struct_type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::spanner::v1::StructType>::GetOwningArena(struct_type);
    if (message_arena != submessage_arena) {
...
inline void StructType_Field::set_allocated_type(::google::spanner::v1::Type* type) {
  ...
  if (type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::google::spanner::v1::Type>::GetOwningArena(type);
    if (message_arena != submessage_arena) {
