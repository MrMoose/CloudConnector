...
inline ::PROTOBUF_NAMESPACE_ID::ListValue* KeyRange::_internal_mutable_start_closed() {
  if (!_internal_has_start_closed()) {
    clear_start_key_type();
    set_has_start_closed();
    start_key_type_.start_closed_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::ListValue >(GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::ListValue* KeyRange::_internal_mutable_start_open() {
  if (!_internal_has_start_open()) {
    clear_start_key_type();
    set_has_start_open();
    start_key_type_.start_open_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::ListValue >(GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::ListValue* KeyRange::_internal_mutable_end_closed() {
  if (!_internal_has_end_closed()) {
    clear_end_key_type();
    set_has_end_closed();
    end_key_type_.end_closed_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::ListValue >(GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::ListValue* KeyRange::_internal_mutable_end_open() {
  if (!_internal_has_end_open()) {
    clear_end_key_type();
    set_has_end_open();
    end_key_type_.end_open_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::ListValue >(GetArenaForAllocation());
  }
