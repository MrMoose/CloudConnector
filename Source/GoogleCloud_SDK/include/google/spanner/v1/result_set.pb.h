...
class ResultSetMetadata final :
 ...
 public:
  ...
  enum : int {
    ...
    kUndeclaredParametersFieldNumber = 3,
  };
  ...
  bool has_undeclared_parameters() const;
  private:
  bool _internal_has_undeclared_parameters() const;
  public:
  void clear_undeclared_parameters();
  const ::google::spanner::v1::StructType& undeclared_parameters() const;
  PROTOBUF_NODISCARD ::google::spanner::v1::StructType* release_undeclared_parameters();
  ::google::spanner::v1::StructType* mutable_undeclared_parameters();
  void set_allocated_undeclared_parameters(::google::spanner::v1::StructType* undeclared_parameters);
  private:
  const ::google::spanner::v1::StructType& _internal_undeclared_parameters() const;
  ::google::spanner::v1::StructType* _internal_mutable_undeclared_parameters();
  public:
  void unsafe_arena_set_allocated_undeclared_parameters(
      ::google::spanner::v1::StructType* undeclared_parameters);
  ::google::spanner::v1::StructType* unsafe_arena_release_undeclared_parameters();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::google::spanner::v1::StructType* undeclared_parameters_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_google_2fspanner_2fv1_2fresult_5fset_2eproto;
...
// .google.spanner.v1.StructType undeclared_parameters = 3;
inline bool ResultSetMetadata::_internal_has_undeclared_parameters() const {
  return this != internal_default_instance() && _impl_.undeclared_parameters_ != nullptr;
}
inline bool ResultSetMetadata::has_undeclared_parameters() const {
  return _internal_has_undeclared_parameters();
}
inline const ::google::spanner::v1::StructType& ResultSetMetadata::_internal_undeclared_parameters() const {
  const ::google::spanner::v1::StructType* p = _impl_.undeclared_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::google::spanner::v1::StructType&>(
      ::google::spanner::v1::_StructType_default_instance_);
}
inline const ::google::spanner::v1::StructType& ResultSetMetadata::undeclared_parameters() const {
  // @@protoc_insertion_point(field_get:google.spanner.v1.ResultSetMetadata.undeclared_parameters)
  return _internal_undeclared_parameters();
}
inline void ResultSetMetadata::unsafe_arena_set_allocated_undeclared_parameters(
    ::google::spanner::v1::StructType* undeclared_parameters) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.undeclared_parameters_);
  }
  _impl_.undeclared_parameters_ = undeclared_parameters;
  if (undeclared_parameters) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:google.spanner.v1.ResultSetMetadata.undeclared_parameters)
}
inline ::google::spanner::v1::StructType* ResultSetMetadata::release_undeclared_parameters() {
  
  ::google::spanner::v1::StructType* temp = _impl_.undeclared_parameters_;
  _impl_.undeclared_parameters_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
...
inline ::google::spanner::v1::StructType* ResultSetMetadata::unsafe_arena_release_undeclared_parameters() {
  // @@protoc_insertion_point(field_release:google.spanner.v1.ResultSetMetadata.undeclared_parameters)
  
  ::google::spanner::v1::StructType* temp = _impl_.undeclared_parameters_;
  _impl_.undeclared_parameters_ = nullptr;
  return temp;
}
inline ::google::spanner::v1::StructType* ResultSetMetadata::_internal_mutable_undeclared_parameters() {
  
  if (_impl_.undeclared_parameters_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::spanner::v1::StructType>(GetArenaForAllocation());
    _impl_.undeclared_parameters_ = p;
  }
  return _impl_.undeclared_parameters_;
}
inline ::google::spanner::v1::StructType* ResultSetMetadata::mutable_undeclared_parameters() {
  ::google::spanner::v1::StructType* _msg = _internal_mutable_undeclared_parameters();
  // @@protoc_insertion_point(field_mutable:google.spanner.v1.ResultSetMetadata.undeclared_parameters)
  return _msg;
}
inline void ResultSetMetadata::set_allocated_undeclared_parameters(::google::spanner::v1::StructType* undeclared_parameters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.undeclared_parameters_);
  }
  if (undeclared_parameters) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(undeclared_parameters));
    if (message_arena != submessage_arena) {
      undeclared_parameters = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, undeclared_parameters, submessage_arena);
    }
  ...
  _impl_.undeclared_parameters_ = undeclared_parameters;
  // @@protoc_insertion_point(field_set_allocated:google.spanner.v1.ResultSetMetadata.undeclared_parameters)
}
