...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fspanner_2fv1_2fcommit_5fresponse_2eproto_metadata_getter(int index);
namespace google {
namespace spanner {
namespace v1 {
...
class CommitResponse_CommitStats PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~CommitResponse_CommitStats();
  ...
  inline CommitResponse_CommitStats* New() const final {
    return CreateMaybeMessage<CommitResponse_CommitStats>(nullptr);
  }

  CommitResponse_CommitStats* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fspanner_2fv1_2fcommit_5fresponse_2eproto_metadata_getter(kIndexInFileMessages);
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 mutation_count() const;
  void set_mutation_count(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_mutation_count() const;
  void _internal_set_mutation_count(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 mutation_count_;
...
class CommitResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  ::google::spanner::v1::CommitResponse_CommitStats* release_commit_stats();
...
inline void CommitResponse_CommitStats::clear_mutation_count() {
  mutation_count_ = PROTOBUF_LONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CommitResponse_CommitStats::_internal_mutation_count() const {
  return mutation_count_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 CommitResponse_CommitStats::mutation_count() const {
...
inline void CommitResponse_CommitStats::_internal_set_mutation_count(::PROTOBUF_NAMESPACE_ID::int64 value) {
  
  mutation_count_ = value;
}
inline void CommitResponse_CommitStats::set_mutation_count(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void CommitResponse::clear_commit_stats() {
  if (GetArena() == nullptr && commit_stats_ != nullptr) {
...
inline ::google::spanner::v1::CommitResponse_CommitStats* CommitResponse::_internal_mutable_commit_stats() {
  ...
  if (commit_stats_ == nullptr) {
    auto* p = CreateMaybeMessage<::google::spanner::v1::CommitResponse_CommitStats>(GetArena());
    commit_stats_ = p;
  }
...
inline ::google::spanner::v1::CommitResponse_CommitStats* CommitResponse::mutable_commit_stats() {
  ...
  return _internal_mutable_commit_stats();
}
inline void CommitResponse::set_allocated_commit_stats(::google::spanner::v1::CommitResponse_CommitStats* commit_stats) {
  ...
  if (commit_stats) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(commit_stats);
    if (message_arena != submessage_arena) {
