...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fspanner_2fv1_2fquery_5fplan_2eproto_metadata_getter(int index);
namespace google {
namespace spanner {
namespace v1 {
class PlanNode;
...
class PlanNode_ChildLink PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr PlanNode_ChildLink(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fspanner_2fv1_2fquery_5fplan_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
public:
  ...
  explicit constexpr PlanNode_ShortRepresentation_SubqueriesEntry_DoNotUse(
...
class PlanNode_ShortRepresentation PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr PlanNode_ShortRepresentation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class QueryPlan PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~QueryPlan();
  explicit constexpr QueryPlan(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
