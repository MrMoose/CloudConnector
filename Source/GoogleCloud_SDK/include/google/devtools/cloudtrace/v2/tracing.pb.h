...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fdevtools_2fcloudtrace_2fv2_2ftracing_2eproto_metadata_getter(int index);
namespace google {
namespace devtools {
...
class BatchWriteSpansRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fdevtools_2fcloudtrace_2fv2_2ftracing_2eproto_metadata_getter(kIndexInFileMessages);
  }
