...
class TimeSeriesTable_ColumnSettings;
struct TimeSeriesTable_ColumnSettingsDefaultTypeInternal;
extern TimeSeriesTable_ColumnSettingsDefaultTypeInternal _TimeSeriesTable_ColumnSettings_default_instance_;
...
template<> ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* Arena::CreateMaybeMessage<::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings>(Arena*);
...
enum TimeSeriesTable_MetricVisualization : int {
  TimeSeriesTable_MetricVisualization_METRIC_VISUALIZATION_UNSPECIFIED = 0,
  TimeSeriesTable_MetricVisualization_NUMBER = 1,
  TimeSeriesTable_MetricVisualization_BAR = 2,
  TimeSeriesTable_MetricVisualization_TimeSeriesTable_MetricVisualization_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  TimeSeriesTable_MetricVisualization_TimeSeriesTable_MetricVisualization_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool TimeSeriesTable_MetricVisualization_IsValid(int value);
constexpr TimeSeriesTable_MetricVisualization TimeSeriesTable_MetricVisualization_MetricVisualization_MIN = TimeSeriesTable_MetricVisualization_METRIC_VISUALIZATION_UNSPECIFIED;
constexpr TimeSeriesTable_MetricVisualization TimeSeriesTable_MetricVisualization_MetricVisualization_MAX = TimeSeriesTable_MetricVisualization_BAR;
constexpr int TimeSeriesTable_MetricVisualization_MetricVisualization_ARRAYSIZE = TimeSeriesTable_MetricVisualization_MetricVisualization_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* TimeSeriesTable_MetricVisualization_descriptor();
template<typename T>
inline const std::string& TimeSeriesTable_MetricVisualization_Name(T enum_t_value) {
  static_assert(::std::is_same<T, TimeSeriesTable_MetricVisualization>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function TimeSeriesTable_MetricVisualization_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    TimeSeriesTable_MetricVisualization_descriptor(), enum_t_value);
}
inline bool TimeSeriesTable_MetricVisualization_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, TimeSeriesTable_MetricVisualization* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<TimeSeriesTable_MetricVisualization>(
    TimeSeriesTable_MetricVisualization_descriptor(), name, value);
}
// ===================================================================
...
class TimeSeriesTable_ColumnSettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings) */ {
 public:
  inline TimeSeriesTable_ColumnSettings() : TimeSeriesTable_ColumnSettings(nullptr) {}
  ~TimeSeriesTable_ColumnSettings() override;
  explicit PROTOBUF_CONSTEXPR TimeSeriesTable_ColumnSettings(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  TimeSeriesTable_ColumnSettings(const TimeSeriesTable_ColumnSettings& from);
  TimeSeriesTable_ColumnSettings(TimeSeriesTable_ColumnSettings&& from) noexcept
    : TimeSeriesTable_ColumnSettings() {
    *this = ::std::move(from);
  }

  inline TimeSeriesTable_ColumnSettings& operator=(const TimeSeriesTable_ColumnSettings& from) {
    CopyFrom(from);
    return *this;
  }
  inline TimeSeriesTable_ColumnSettings& operator=(TimeSeriesTable_ColumnSettings&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const TimeSeriesTable_ColumnSettings& default_instance() {
    return *internal_default_instance();
  }
  static inline const TimeSeriesTable_ColumnSettings* internal_default_instance() {
    return reinterpret_cast<const TimeSeriesTable_ColumnSettings*>(
               &_TimeSeriesTable_ColumnSettings_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(TimeSeriesTable_ColumnSettings& a, TimeSeriesTable_ColumnSettings& b) {
    a.Swap(&b);
  }
  inline void Swap(TimeSeriesTable_ColumnSettings* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(TimeSeriesTable_ColumnSettings* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  TimeSeriesTable_ColumnSettings* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<TimeSeriesTable_ColumnSettings>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const TimeSeriesTable_ColumnSettings& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const TimeSeriesTable_ColumnSettings& from) {
    TimeSeriesTable_ColumnSettings::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(TimeSeriesTable_ColumnSettings* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings";
  }
  protected:
  explicit TimeSeriesTable_ColumnSettings(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class TimeSeriesTable final :
 ...
 public:
  ...
  typedef TimeSeriesTable_ColumnSettings ColumnSettings;

  typedef TimeSeriesTable_MetricVisualization MetricVisualization;
  static constexpr MetricVisualization METRIC_VISUALIZATION_UNSPECIFIED =
    TimeSeriesTable_MetricVisualization_METRIC_VISUALIZATION_UNSPECIFIED;
  static constexpr MetricVisualization NUMBER =
    TimeSeriesTable_MetricVisualization_NUMBER;
  static constexpr MetricVisualization BAR =
    TimeSeriesTable_MetricVisualization_BAR;
  static inline bool MetricVisualization_IsValid(int value) {
    return TimeSeriesTable_MetricVisualization_IsValid(value);
  }
  static constexpr MetricVisualization MetricVisualization_MIN =
    TimeSeriesTable_MetricVisualization_MetricVisualization_MIN;
  static constexpr MetricVisualization MetricVisualization_MAX =
    TimeSeriesTable_MetricVisualization_MetricVisualization_MAX;
  static constexpr int MetricVisualization_ARRAYSIZE =
    TimeSeriesTable_MetricVisualization_MetricVisualization_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  MetricVisualization_descriptor() {
    return TimeSeriesTable_MetricVisualization_descriptor();
  }
  template<typename T>
  static inline const std::string& MetricVisualization_Name(T enum_t_value) {
    static_assert(::std::is_same<T, MetricVisualization>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function MetricVisualization_Name.");
    return TimeSeriesTable_MetricVisualization_Name(enum_t_value);
  }
  static inline bool MetricVisualization_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      MetricVisualization* value) {
    return TimeSeriesTable_MetricVisualization_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kColumnSettingsFieldNumber = 4,
    kMetricVisualizationFieldNumber = 2,
  };
  ...
  int column_settings_size() const;
  private:
  int _internal_column_settings_size() const;
  public:
  void clear_column_settings();
  ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* mutable_column_settings(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings >*
      mutable_column_settings();
  private:
  const ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings& _internal_column_settings(int index) const;
  ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* _internal_add_column_settings();
  public:
  const ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings& column_settings(int index) const;
  ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* add_column_settings();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings >&
      column_settings() const;
  ...
  void clear_metric_visualization();
  ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization metric_visualization() const;
  void set_metric_visualization(::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization value);
  private:
  ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization _internal_metric_visualization() const;
  void _internal_set_metric_visualization(::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings > column_settings_;
    int metric_visualization_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_google_2fmonitoring_2fdashboard_2fv1_2ftable_2eproto;
...
// string column = 1 [(.google.api.field_behavior) = REQUIRED];
inline void TimeSeriesTable_ColumnSettings::clear_column() {
  _impl_.column_.ClearToEmpty();
}
inline const std::string& TimeSeriesTable_ColumnSettings::column() const {
  // @@protoc_insertion_point(field_get:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.column)
  return _internal_column();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TimeSeriesTable_ColumnSettings::set_column(ArgT0&& arg0, ArgT... args) {
 
 _impl_.column_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.column)
}
inline std::string* TimeSeriesTable_ColumnSettings::mutable_column() {
  std::string* _s = _internal_mutable_column();
  // @@protoc_insertion_point(field_mutable:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.column)
  return _s;
}
inline const std::string& TimeSeriesTable_ColumnSettings::_internal_column() const {
  return _impl_.column_.Get();
}
inline void TimeSeriesTable_ColumnSettings::_internal_set_column(const std::string& value) {
  
  _impl_.column_.Set(value, GetArenaForAllocation());
}
inline std::string* TimeSeriesTable_ColumnSettings::_internal_mutable_column() {
  
  return _impl_.column_.Mutable(GetArenaForAllocation());
}
inline std::string* TimeSeriesTable_ColumnSettings::release_column() {
  // @@protoc_insertion_point(field_release:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.column)
  return _impl_.column_.Release();
}
inline void TimeSeriesTable_ColumnSettings::set_allocated_column(std::string* column) {
  if (column != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.column)
}

// bool visible = 2 [(.google.api.field_behavior) = REQUIRED];
inline void TimeSeriesTable_ColumnSettings::clear_visible() {
  _impl_.visible_ = false;
}
inline bool TimeSeriesTable_ColumnSettings::_internal_visible() const {
  return _impl_.visible_;
}
inline bool TimeSeriesTable_ColumnSettings::visible() const {
  // @@protoc_insertion_point(field_get:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.visible)
  return _internal_visible();
}
inline void TimeSeriesTable_ColumnSettings::_internal_set_visible(bool value) {
  
  _impl_.visible_ = value;
}
inline void TimeSeriesTable_ColumnSettings::set_visible(bool value) {
  _internal_set_visible(value);
  // @@protoc_insertion_point(field_set:google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings.visible)
}
...
// .google.monitoring.dashboard.v1.TimeSeriesTable.MetricVisualization metric_visualization = 2 [(.google.api.field_behavior) = OPTIONAL];
inline void TimeSeriesTable::clear_metric_visualization() {
  _impl_.metric_visualization_ = 0;
}
inline ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization TimeSeriesTable::_internal_metric_visualization() const {
  return static_cast< ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization >(_impl_.metric_visualization_);
}
inline ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization TimeSeriesTable::metric_visualization() const {
  // @@protoc_insertion_point(field_get:google.monitoring.dashboard.v1.TimeSeriesTable.metric_visualization)
  return _internal_metric_visualization();
}
inline void TimeSeriesTable::_internal_set_metric_visualization(::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization value) {
  
  _impl_.metric_visualization_ = value;
}
inline void TimeSeriesTable::set_metric_visualization(::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization value) {
  _internal_set_metric_visualization(value);
  // @@protoc_insertion_point(field_set:google.monitoring.dashboard.v1.TimeSeriesTable.metric_visualization)
}

// repeated .google.monitoring.dashboard.v1.TimeSeriesTable.ColumnSettings column_settings = 4 [(.google.api.field_behavior) = OPTIONAL];
inline int TimeSeriesTable::_internal_column_settings_size() const {
  return _impl_.column_settings_.size();
}
inline int TimeSeriesTable::column_settings_size() const {
  return _internal_column_settings_size();
}
inline void TimeSeriesTable::clear_column_settings() {
  _impl_.column_settings_.Clear();
}
inline ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* TimeSeriesTable::mutable_column_settings(int index) {
  // @@protoc_insertion_point(field_mutable:google.monitoring.dashboard.v1.TimeSeriesTable.column_settings)
  return _impl_.column_settings_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings >*
TimeSeriesTable::mutable_column_settings() {
  // @@protoc_insertion_point(field_mutable_list:google.monitoring.dashboard.v1.TimeSeriesTable.column_settings)
  return &_impl_.column_settings_;
}
inline const ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings& TimeSeriesTable::_internal_column_settings(int index) const {
  return _impl_.column_settings_.Get(index);
}
inline const ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings& TimeSeriesTable::column_settings(int index) const {
  // @@protoc_insertion_point(field_get:google.monitoring.dashboard.v1.TimeSeriesTable.column_settings)
  return _internal_column_settings(index);
}
inline ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* TimeSeriesTable::_internal_add_column_settings() {
  return _impl_.column_settings_.Add();
}
inline ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* TimeSeriesTable::add_column_settings() {
  ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings* _add = _internal_add_column_settings();
  // @@protoc_insertion_point(field_add:google.monitoring.dashboard.v1.TimeSeriesTable.column_settings)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::google::monitoring::dashboard::v1::TimeSeriesTable_ColumnSettings >&
TimeSeriesTable::column_settings() const {
  // @@protoc_insertion_point(field_list:google.monitoring.dashboard.v1.TimeSeriesTable.column_settings)
  return _impl_.column_settings_;
}
...
template <> struct is_proto_enum< ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization>() {
  return ::google::monitoring::dashboard::v1::TimeSeriesTable_MetricVisualization_descriptor();
}
