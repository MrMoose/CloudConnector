...
class TimeSeriesTable_TableDataSet final :
 ...
 public:
  ...
  explicit constexpr TimeSeriesTable_TableDataSet(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class TimeSeriesTable final :
 ...
 public:
  ...
  explicit constexpr TimeSeriesTable(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void TimeSeriesTable_TableDataSet::set_table_template(ArgT0&& arg0, ArgT... args) {
 ...
 table_template_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& TimeSeriesTable_TableDataSet::_internal_table_template() const {
  return table_template_.Get();
}
inline void TimeSeriesTable_TableDataSet::_internal_set_table_template(const std::string& value) {
  
  table_template_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* TimeSeriesTable_TableDataSet::_internal_mutable_table_template() {
  
  return table_template_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* TimeSeriesTable_TableDataSet::release_table_template() {
  ...
  return table_template_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void TimeSeriesTable_TableDataSet::set_allocated_table_template(std::string* table_template) {
  ...
  table_template_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), table_template,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (table_template_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    table_template_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
inline bool TimeSeriesTable_TableDataSet::_internal_has_table_display_options() const {
  return this != internal_default_instance() && table_display_options_ != nullptr;
}
...
inline const ::google::monitoring::dashboard::v1::TableDisplayOptions& TimeSeriesTable_TableDataSet::_internal_table_display_options() const {
  const ::google::monitoring::dashboard::v1::TableDisplayOptions* p = table_display_options_;
...
inline void TimeSeriesTable_TableDataSet::unsafe_arena_set_allocated_table_display_options(
    ::google::monitoring::dashboard::v1::TableDisplayOptions* table_display_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(table_display_options_);
  }
  table_display_options_ = table_display_options;
...
inline ::google::monitoring::dashboard::v1::TableDisplayOptions* TimeSeriesTable_TableDataSet::release_table_display_options() {
  ...
  ::google::monitoring::dashboard::v1::TableDisplayOptions* temp = table_display_options_;
  table_display_options_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  if (GetArenaForAllocation() == nullptr) { delete old; }
