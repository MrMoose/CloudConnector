...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fmonitoring_2fv3_2fcommon_2eproto_metadata_getter(int index);
namespace google {
...
enum Aggregation_Aligner : int {
  ...
  Aggregation_Aligner_Aggregation_Aligner_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Aggregation_Aligner_Aggregation_Aligner_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum Aggregation_Reducer : int {
  ...
  Aggregation_Reducer_Aggregation_Reducer_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  Aggregation_Reducer_Aggregation_Reducer_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum ComparisonType : int {
  ...
  COMPARISON_EQ = 5,
  COMPARISON_NE = 6,
  ComparisonType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ComparisonType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum ServiceTier : int {
  ...
  ServiceTier_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ServiceTier_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class TypedValue PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fmonitoring_2fv3_2fcommon_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Aggregation PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_NAMESPACE_ID::Duration* release_alignment_period();
...
inline ::PROTOBUF_NAMESPACE_ID::int64 TypedValue::_internal_int64_value() const {
  if (_internal_has_int64_value()) {
    return value_.int64_value_;
  }
  return PROTOBUF_LONGLONG(0);
}
inline void TypedValue::_internal_set_int64_value(::PROTOBUF_NAMESPACE_ID::int64 value) {
  if (!_internal_has_int64_value()) {
    clear_value();
    set_has_int64_value();
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64 TypedValue::int64_value() const {
  // @@protoc_insertion_point(field_get:google.monitoring.v3.TypedValue.int64_value)
  return _internal_int64_value();
}
inline void TypedValue::set_int64_value(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::google::api::Distribution* TypedValue::_internal_mutable_distribution_value() {
  if (!_internal_has_distribution_value()) {
    clear_value();
    set_has_distribution_value();
    value_.distribution_value_ = CreateMaybeMessage< ::google::api::Distribution >(GetArena());
  }
...
inline PROTOBUF_NAMESPACE_ID::Duration* Aggregation::mutable_alignment_period() {
  ...
  return _internal_mutable_alignment_period();
}
inline void Aggregation::set_allocated_alignment_period(PROTOBUF_NAMESPACE_ID::Duration* alignment_period) {
  ...
  if (alignment_period) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(alignment_period)->GetArena();
    if (message_arena != submessage_arena) {
...
inline std::string* Aggregation::add_group_by_fields() {
  ...
  return _internal_add_group_by_fields();
}
