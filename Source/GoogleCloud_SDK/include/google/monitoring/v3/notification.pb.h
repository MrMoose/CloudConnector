...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto_metadata_getter(int index);
namespace google {
...
enum NotificationChannel_VerificationStatus : int {
  ...
  NotificationChannel_VerificationStatus_NotificationChannel_VerificationStatus_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  NotificationChannel_VerificationStatus_NotificationChannel_VerificationStatus_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class NotificationChannelDescriptor PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr NotificationChannelDescriptor(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline NotificationChannelDescriptor* New() const final {
    return CreateMaybeMessage<NotificationChannelDescriptor>(nullptr);
  }

  NotificationChannelDescriptor* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
public:
  ...
  explicit constexpr NotificationChannel_LabelsEntry_DoNotUse(
  ...
  private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto);
    return ::descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto.file_level_metadata[1];
  }
...
public:
  ...
  explicit constexpr NotificationChannel_UserLabelsEntry_DoNotUse(
      ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto);
    return ::descriptor_table_google_2fmonitoring_2fv3_2fnotification_2eproto.file_level_metadata[2];
  }
...
class NotificationChannel PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr NotificationChannel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline ::google::monitoring::v3::MutationRecord* NotificationChannel::mutable_mutation_records(int index) {
  ...
  return mutation_records_.Mutable(index);
}
...
inline const ::google::monitoring::v3::MutationRecord& NotificationChannel::_internal_mutation_records(int index) const {
  return mutation_records_.Get(index);
}
...
inline ::google::monitoring::v3::MutationRecord* NotificationChannel::add_mutation_records() {
  ...
  return _internal_add_mutation_records();
}
