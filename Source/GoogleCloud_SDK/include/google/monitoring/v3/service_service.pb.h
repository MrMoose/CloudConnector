...
void CreateServiceLevelObjectiveRequest::set_service_level_objective_id(ArgT0&& arg0, ArgT... args) {
 ...
 service_level_objective_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CreateServiceLevelObjectiveRequest::_internal_set_service_level_objective_id(const std::string& value) {
  ...
  service_level_objective_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* CreateServiceLevelObjectiveRequest::_internal_mutable_service_level_objective_id() {
  
  return service_level_objective_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* CreateServiceLevelObjectiveRequest::release_service_level_objective_id() {
  ...
  return service_level_objective_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void CreateServiceLevelObjectiveRequest::set_allocated_service_level_objective_id(std::string* service_level_objective_id) {
  ...
  service_level_objective_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service_level_objective_id,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (service_level_objective_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    service_level_objective_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
