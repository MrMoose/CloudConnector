...
class SpanContext final :
 ...
 public:
  ...
  explicit constexpr SpanContext(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* SpanContext::release_span_name() {
  ...
  return span_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void SpanContext::set_allocated_span_name(std::string* span_name) {
  ...
  if (span_name_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    span_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
