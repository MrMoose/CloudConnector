...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fmonitoring_2fv3_2fspan_5fcontext_2eproto_metadata_getter(int index);
namespace google {
...
class SpanContext PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fmonitoring_2fv3_2fspan_5fcontext_2eproto_metadata_getter(kIndexInFileMessages);
  }
