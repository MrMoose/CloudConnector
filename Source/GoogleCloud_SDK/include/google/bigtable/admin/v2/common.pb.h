...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_google_2fbigtable_2fadmin_2fv2_2fcommon_2eproto_metadata_getter(int index);
namespace google {
namespace bigtable {
namespace admin {
namespace v2 {
...
class OperationProgress PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_google_2fbigtable_2fadmin_2fv2_2fcommon_2eproto_metadata_getter(kIndexInFileMessages);
  }
