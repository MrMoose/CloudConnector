...
class SchemaSettings final :
 ...
 public:
  ...
  enum : int {
    ...
    kFirstRevisionIdFieldNumber = 3,
    kLastRevisionIdFieldNumber = 4,
  ...
  void clear_first_revision_id();
  const std::string& first_revision_id() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_first_revision_id(ArgT0&& arg0, ArgT... args);
  std::string* mutable_first_revision_id();
  PROTOBUF_NODISCARD std::string* release_first_revision_id();
  void set_allocated_first_revision_id(std::string* first_revision_id);
  private:
  const std::string& _internal_first_revision_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_first_revision_id(const std::string& value);
  std::string* _internal_mutable_first_revision_id();
  public:

  // string last_revision_id = 4;
  void clear_last_revision_id();
  const std::string& last_revision_id() const;
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_last_revision_id(ArgT0&& arg0, ArgT... args);
  std::string* mutable_last_revision_id();
  PROTOBUF_NODISCARD std::string* release_last_revision_id();
  void set_allocated_last_revision_id(std::string* last_revision_id);
  private:
  const std::string& _internal_last_revision_id() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_last_revision_id(const std::string& value);
  std::string* _internal_mutable_last_revision_id();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr first_revision_id_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr last_revision_id_;
    int encoding_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class StreamingPullResponse_AcknowledgeConfirmation final :
 ...
 public:
  ...
  enum : int {
    ...
    kTemporaryFailedAckIdsFieldNumber = 4,
  };
  ...
  int temporary_failed_ack_ids_size() const;
  private:
  int _internal_temporary_failed_ack_ids_size() const;
  public:
  void clear_temporary_failed_ack_ids();
  const std::string& temporary_failed_ack_ids(int index) const;
  std::string* mutable_temporary_failed_ack_ids(int index);
  void set_temporary_failed_ack_ids(int index, const std::string& value);
  void set_temporary_failed_ack_ids(int index, std::string&& value);
  void set_temporary_failed_ack_ids(int index, const char* value);
  void set_temporary_failed_ack_ids(int index, const char* value, size_t size);
  std::string* add_temporary_failed_ack_ids();
  void add_temporary_failed_ack_ids(const std::string& value);
  void add_temporary_failed_ack_ids(std::string&& value);
  void add_temporary_failed_ack_ids(const char* value);
  void add_temporary_failed_ack_ids(const char* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& temporary_failed_ack_ids() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_temporary_failed_ack_ids();
  private:
  const std::string& _internal_temporary_failed_ack_ids(int index) const;
  std::string* _internal_add_temporary_failed_ack_ids();
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> temporary_failed_ack_ids_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_google_2fpubsub_2fv1_2fpubsub_2eproto;
...
class StreamingPullResponse_ModifyAckDeadlineConfirmation final :
 ...
 public:
  ...
  enum : int {
    kAckIdsFieldNumber = 1,
    kInvalidAckIdsFieldNumber = 2,
    kTemporaryFailedAckIdsFieldNumber = 3,
  };
  // repeated string ack_ids = 1;
  int ack_ids_size() const;
  private:
...
// string first_revision_id = 3;
inline void SchemaSettings::clear_first_revision_id() {
  _impl_.first_revision_id_.ClearToEmpty();
}
inline const std::string& SchemaSettings::first_revision_id() const {
  // @@protoc_insertion_point(field_get:google.pubsub.v1.SchemaSettings.first_revision_id)
  return _internal_first_revision_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SchemaSettings::set_first_revision_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.first_revision_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.pubsub.v1.SchemaSettings.first_revision_id)
}
inline std::string* SchemaSettings::mutable_first_revision_id() {
  std::string* _s = _internal_mutable_first_revision_id();
  // @@protoc_insertion_point(field_mutable:google.pubsub.v1.SchemaSettings.first_revision_id)
  return _s;
}
inline const std::string& SchemaSettings::_internal_first_revision_id() const {
  return _impl_.first_revision_id_.Get();
}
inline void SchemaSettings::_internal_set_first_revision_id(const std::string& value) {
  
  _impl_.first_revision_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SchemaSettings::_internal_mutable_first_revision_id() {
  
  return _impl_.first_revision_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SchemaSettings::release_first_revision_id() {
  // @@protoc_insertion_point(field_release:google.pubsub.v1.SchemaSettings.first_revision_id)
  return _impl_.first_revision_id_.Release();
}
inline void SchemaSettings::set_allocated_first_revision_id(std::string* first_revision_id) {
  if (first_revision_id != nullptr) {
    
  } else {
    
  }
  _impl_.first_revision_id_.SetAllocated(first_revision_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.first_revision_id_.IsDefault()) {
    _impl_.first_revision_id_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.pubsub.v1.SchemaSettings.first_revision_id)
}

// string last_revision_id = 4;
inline void SchemaSettings::clear_last_revision_id() {
  _impl_.last_revision_id_.ClearToEmpty();
}
inline const std::string& SchemaSettings::last_revision_id() const {
  // @@protoc_insertion_point(field_get:google.pubsub.v1.SchemaSettings.last_revision_id)
  return _internal_last_revision_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SchemaSettings::set_last_revision_id(ArgT0&& arg0, ArgT... args) {
 
 _impl_.last_revision_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:google.pubsub.v1.SchemaSettings.last_revision_id)
}
inline std::string* SchemaSettings::mutable_last_revision_id() {
  std::string* _s = _internal_mutable_last_revision_id();
  // @@protoc_insertion_point(field_mutable:google.pubsub.v1.SchemaSettings.last_revision_id)
  return _s;
}
inline const std::string& SchemaSettings::_internal_last_revision_id() const {
  return _impl_.last_revision_id_.Get();
}
inline void SchemaSettings::_internal_set_last_revision_id(const std::string& value) {
  
  _impl_.last_revision_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SchemaSettings::_internal_mutable_last_revision_id() {
  
  return _impl_.last_revision_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SchemaSettings::release_last_revision_id() {
  // @@protoc_insertion_point(field_release:google.pubsub.v1.SchemaSettings.last_revision_id)
  return _impl_.last_revision_id_.Release();
}
inline void SchemaSettings::set_allocated_last_revision_id(std::string* last_revision_id) {
  if (last_revision_id != nullptr) {
    
  } else {
    
  }
  _impl_.last_revision_id_.SetAllocated(last_revision_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.last_revision_id_.IsDefault()) {
    _impl_.last_revision_id_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:google.pubsub.v1.SchemaSettings.last_revision_id)
}
...
// repeated string temporary_failed_ack_ids = 4;
inline int StreamingPullResponse_AcknowledgeConfirmation::_internal_temporary_failed_ack_ids_size() const {
  return _impl_.temporary_failed_ack_ids_.size();
}
inline int StreamingPullResponse_AcknowledgeConfirmation::temporary_failed_ack_ids_size() const {
  return _internal_temporary_failed_ack_ids_size();
}
inline void StreamingPullResponse_AcknowledgeConfirmation::clear_temporary_failed_ack_ids() {
  _impl_.temporary_failed_ack_ids_.Clear();
}
inline std::string* StreamingPullResponse_AcknowledgeConfirmation::add_temporary_failed_ack_ids() {
  std::string* _s = _internal_add_temporary_failed_ack_ids();
  // @@protoc_insertion_point(field_add_mutable:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
  return _s;
}
inline const std::string& StreamingPullResponse_AcknowledgeConfirmation::_internal_temporary_failed_ack_ids(int index) const {
  return _impl_.temporary_failed_ack_ids_.Get(index);
}
inline const std::string& StreamingPullResponse_AcknowledgeConfirmation::temporary_failed_ack_ids(int index) const {
  // @@protoc_insertion_point(field_get:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
  return _internal_temporary_failed_ack_ids(index);
}
inline std::string* StreamingPullResponse_AcknowledgeConfirmation::mutable_temporary_failed_ack_ids(int index) {
  // @@protoc_insertion_point(field_mutable:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
  return _impl_.temporary_failed_ack_ids_.Mutable(index);
}
inline void StreamingPullResponse_AcknowledgeConfirmation::set_temporary_failed_ack_ids(int index, const std::string& value) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::set_temporary_failed_ack_ids(int index, std::string&& value) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::set_temporary_failed_ack_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::set_temporary_failed_ack_ids(int index, const char* value, size_t size) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline std::string* StreamingPullResponse_AcknowledgeConfirmation::_internal_add_temporary_failed_ack_ids() {
  return _impl_.temporary_failed_ack_ids_.Add();
}
inline void StreamingPullResponse_AcknowledgeConfirmation::add_temporary_failed_ack_ids(const std::string& value) {
  _impl_.temporary_failed_ack_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::add_temporary_failed_ack_ids(std::string&& value) {
  _impl_.temporary_failed_ack_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::add_temporary_failed_ack_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.temporary_failed_ack_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_AcknowledgeConfirmation::add_temporary_failed_ack_ids(const char* value, size_t size) {
  _impl_.temporary_failed_ack_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
StreamingPullResponse_AcknowledgeConfirmation::temporary_failed_ack_ids() const {
  // @@protoc_insertion_point(field_list:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
  return _impl_.temporary_failed_ack_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
StreamingPullResponse_AcknowledgeConfirmation::mutable_temporary_failed_ack_ids() {
  // @@protoc_insertion_point(field_mutable_list:google.pubsub.v1.StreamingPullResponse.AcknowledgeConfirmation.temporary_failed_ack_ids)
  return &_impl_.temporary_failed_ack_ids_;
}
...
// repeated string temporary_failed_ack_ids = 3;
inline int StreamingPullResponse_ModifyAckDeadlineConfirmation::_internal_temporary_failed_ack_ids_size() const {
  return _impl_.temporary_failed_ack_ids_.size();
}
inline int StreamingPullResponse_ModifyAckDeadlineConfirmation::temporary_failed_ack_ids_size() const {
  return _internal_temporary_failed_ack_ids_size();
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::clear_temporary_failed_ack_ids() {
  _impl_.temporary_failed_ack_ids_.Clear();
}
inline std::string* StreamingPullResponse_ModifyAckDeadlineConfirmation::add_temporary_failed_ack_ids() {
  std::string* _s = _internal_add_temporary_failed_ack_ids();
  // @@protoc_insertion_point(field_add_mutable:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
  return _s;
}
inline const std::string& StreamingPullResponse_ModifyAckDeadlineConfirmation::_internal_temporary_failed_ack_ids(int index) const {
  return _impl_.temporary_failed_ack_ids_.Get(index);
}
inline const std::string& StreamingPullResponse_ModifyAckDeadlineConfirmation::temporary_failed_ack_ids(int index) const {
  // @@protoc_insertion_point(field_get:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
  return _internal_temporary_failed_ack_ids(index);
}
inline std::string* StreamingPullResponse_ModifyAckDeadlineConfirmation::mutable_temporary_failed_ack_ids(int index) {
  // @@protoc_insertion_point(field_mutable:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
  return _impl_.temporary_failed_ack_ids_.Mutable(index);
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::set_temporary_failed_ack_ids(int index, const std::string& value) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::set_temporary_failed_ack_ids(int index, std::string&& value) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::set_temporary_failed_ack_ids(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::set_temporary_failed_ack_ids(int index, const char* value, size_t size) {
  _impl_.temporary_failed_ack_ids_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline std::string* StreamingPullResponse_ModifyAckDeadlineConfirmation::_internal_add_temporary_failed_ack_ids() {
  return _impl_.temporary_failed_ack_ids_.Add();
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::add_temporary_failed_ack_ids(const std::string& value) {
  _impl_.temporary_failed_ack_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::add_temporary_failed_ack_ids(std::string&& value) {
  _impl_.temporary_failed_ack_ids_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::add_temporary_failed_ack_ids(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.temporary_failed_ack_ids_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline void StreamingPullResponse_ModifyAckDeadlineConfirmation::add_temporary_failed_ack_ids(const char* value, size_t size) {
  _impl_.temporary_failed_ack_ids_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
StreamingPullResponse_ModifyAckDeadlineConfirmation::temporary_failed_ack_ids() const {
  // @@protoc_insertion_point(field_list:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
  return _impl_.temporary_failed_ack_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
StreamingPullResponse_ModifyAckDeadlineConfirmation::mutable_temporary_failed_ack_ids() {
  // @@protoc_insertion_point(field_mutable_list:google.pubsub.v1.StreamingPullResponse.ModifyAckDeadlineConfirmation.temporary_failed_ack_ids)
  return &_impl_.temporary_failed_ack_ids_;
}
