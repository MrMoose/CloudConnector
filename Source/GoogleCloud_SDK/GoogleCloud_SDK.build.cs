...
public class GoogleCloud_SDK : ModuleRules {
    ...
    public GoogleCloud_SDK(ReadOnlyTargetRules Target) : base(Target) {
		...
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_bigtable.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_bigtable_protos.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_cloud_bigquery_protos.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_cloud_dialogflow_v2beta1_protos.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_cloud_dialogflow_v2_protos.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_cloud_speech_protos.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_cloud_texttospeech_protos.lib"));
		...
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_firestore.lib"));
		...
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_logging_type_protos.lib"));
		...
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_spanner.lib"));
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "google_cloud_cpp_spanner_protos.lib"));
