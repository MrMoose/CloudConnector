...
public class AWS_SDK : ModuleRules {
    ...
    public AWS_SDK(ReadOnlyTargetRules Target) : base(Target) {
		...
		PublicAdditionalLibraries.Add(Path.Combine(LibrariesPath, "aws-c-sdkutils.lib"));
		...
		RuntimeDependencies.Add("$(BinaryOutputDir)/aws-c-sdkutils.dll", Path.Combine(DLLPath, "aws-c-sdkutils.dll"));
